...
public class WSDLObjectActive_starter extends WSDLObject {
	...
	public static WSDLObjectActive_starter createFromXML(Element e) throws IOException {
		if (e.getValue().equalsIgnoreCase("false")) return new WSDLObjectActive_starter(EnumValue_Active_starter.TRUE);
		if (e.getValue().equalsIgnoreCase("false")) return new WSDLObjectActive_starter(EnumValue_Active_starter.FALSE);
		if (e.getValue().equalsIgnoreCase("substitute")) return new WSDLObjectActive_starter(EnumValue_Active_starter.SUBSTITUTE);
