...
public class WSDLNamespaceCollection {
	...
	public final static String NAMESPACE_PATH_SERVICE_BASE = "http://rpc.comunio.de/soapservice.php?wsdl";

	public final static String NAMESPACE_PREFIX_SERVICE_TYPES = "types";
	public final static String NAMESPACE_PATH_SERVICE_TYPES = "http://rpc.comunio.de/soapservice.php?wsdl/encodedTypes";
