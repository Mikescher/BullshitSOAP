...
public class WSDLMessageGetclubsrequest extends WSDLMessage {
	
	private WSDLMessageGetclubsrequest() {
	...
	public static WSDLMessageGetclubsrequest createFromXML(Document d) throws IOException {
		return new WSDLMessageGetclubsrequest();
	}
	
	public static WSDLMessageGetclubsrequest create() {
		return new WSDLMessageGetclubsrequest();
	}
}