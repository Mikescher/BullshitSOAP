...
public class WSDLMessageCommunityexistsresponse extends WSDLMessage {

    public final WSDLObjectBoolean field_return;
	
	private WSDLMessageCommunityexistsresponse(WSDLObjectBoolean _return) {
	...
	public static WSDLMessageCommunityexistsresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "communityexistsResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageCommunityexistsresponse(WSDLObjectBoolean.createFromXML(xml_return));
	}
	
	public static WSDLMessageCommunityexistsresponse create(WSDLObjectBoolean _return) {
		return new WSDLMessageCommunityexistsresponse(_return);
	}
}