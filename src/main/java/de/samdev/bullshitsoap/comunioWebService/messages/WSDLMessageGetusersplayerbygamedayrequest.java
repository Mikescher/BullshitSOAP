...
public class WSDLMessageGetusersplayerbygamedayrequest extends WSDLMessage {
	...
	public static WSDLMessageGetusersplayerbygamedayrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getusersplayerbygamedayRequest");
