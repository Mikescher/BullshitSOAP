...
public class WSDLMessageSetusertitleresponse extends WSDLMessage {

    public final WSDLObjectBoolean field_return;
	
	private WSDLMessageSetusertitleresponse(WSDLObjectBoolean _return) {
	...
	public static WSDLMessageSetusertitleresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "setusertitleResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageSetusertitleresponse(WSDLObjectBoolean.createFromXML(xml_return));
	}
	
	public static WSDLMessageSetusertitleresponse create(WSDLObjectBoolean _return) {
		return new WSDLMessageSetusertitleresponse(_return);
	}
}