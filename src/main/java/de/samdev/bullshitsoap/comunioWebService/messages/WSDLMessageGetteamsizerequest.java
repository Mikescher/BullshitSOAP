...
public class WSDLMessageGetteamsizerequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	private WSDLMessageGetteamsizerequest(WSDLObjectInt _userid) {
	...
	public static WSDLMessageGetteamsizerequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getteamsizeRequest");
		
		Element xml_userid = getFirstChildrenIgnoreNamespace(message, "userid");
		
		return new WSDLMessageGetteamsizerequest(WSDLObjectInt.createFromXML(xml_userid));
	}
	
	public static WSDLMessageGetteamsizerequest create(WSDLObjectInt _userid) {
		return new WSDLMessageGetteamsizerequest(_userid);
	}
}