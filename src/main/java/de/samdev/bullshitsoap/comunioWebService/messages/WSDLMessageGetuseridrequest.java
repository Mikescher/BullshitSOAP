...
public class WSDLMessageGetuseridrequest extends WSDLMessage {

    public final WSDLObjectString field_login;
	
	private WSDLMessageGetuseridrequest(WSDLObjectString _login) {
	...
	public Document serialize(String opname) {
		...
		message.appendChild(field_login.serialize("login"));
	...
	public static WSDLMessageGetuseridrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getuseridRequest");
		
		Element xml_login = getFirstChildrenIgnoreNamespace(message, "login");
		
		return new WSDLMessageGetuseridrequest(WSDLObjectString.createFromXML(xml_login));
	}
	
	public static WSDLMessageGetuseridrequest create(WSDLObjectString _login) {
		return new WSDLMessageGetuseridrequest(_login);
	}
}