...
public class WSDLMessageGetbestlineupbygamedayresponse extends WSDLMessage {

    public final WSDLObjectArrayofplayerscore field_return;
	
	private WSDLMessageGetbestlineupbygamedayresponse(WSDLObjectArrayofplayerscore _return) {
	...
	public static WSDLMessageGetbestlineupbygamedayresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getbestlineupbygamedayResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetbestlineupbygamedayresponse(WSDLObjectArrayofplayerscore.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetbestlineupbygamedayresponse create(WSDLObjectArrayofplayerscore _return) {
		return new WSDLMessageGetbestlineupbygamedayresponse(_return);
	}
}