...
public class WSDLMessageGetplayerssoldresponse extends WSDLMessage {

    public final WSDLObjectArrayoftransferitem field_return;
	
	private WSDLMessageGetplayerssoldresponse(WSDLObjectArrayoftransferitem _return) {
	...
	public static WSDLMessageGetplayerssoldresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayerssoldResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetplayerssoldresponse(WSDLObjectArrayoftransferitem.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetplayerssoldresponse create(WSDLObjectArrayoftransferitem _return) {
		return new WSDLMessageGetplayerssoldresponse(_return);
	}
}