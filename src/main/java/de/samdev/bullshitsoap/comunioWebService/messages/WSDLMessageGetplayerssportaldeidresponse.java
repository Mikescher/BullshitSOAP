...
public class WSDLMessageGetplayerssportaldeidresponse extends WSDLMessage {

    public final WSDLObjectInt field_return;
	
	private WSDLMessageGetplayerssportaldeidresponse(WSDLObjectInt _return) {
	...
	public static WSDLMessageGetplayerssportaldeidresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayerssportaldeidResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetplayerssportaldeidresponse(WSDLObjectInt.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetplayerssportaldeidresponse create(WSDLObjectInt _return) {
		return new WSDLMessageGetplayerssportaldeidresponse(_return);
	}
}