...
public class WSDLMessageGetservicerankingresponse extends WSDLMessage {

    public final WSDLObjectArrayofuser field_return;
	
	private WSDLMessageGetservicerankingresponse(WSDLObjectArrayofuser _return) {
	...
	public static WSDLMessageGetservicerankingresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getservicerankingResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetservicerankingresponse(WSDLObjectArrayofuser.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetservicerankingresponse create(WSDLObjectArrayofuser _return) {
		return new WSDLMessageGetservicerankingresponse(_return);
	}
}