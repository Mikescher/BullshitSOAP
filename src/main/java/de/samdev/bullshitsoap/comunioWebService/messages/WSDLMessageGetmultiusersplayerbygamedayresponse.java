...
public class WSDLMessageGetmultiusersplayerbygamedayresponse extends WSDLMessage {

    public final WSDLObjectArrayofarrayofplayerlineup field_return;
	
	private WSDLMessageGetmultiusersplayerbygamedayresponse(WSDLObjectArrayofarrayofplayerlineup _return) {
	...
	public static WSDLMessageGetmultiusersplayerbygamedayresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getmultiusersplayerbygamedayResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetmultiusersplayerbygamedayresponse(WSDLObjectArrayofarrayofplayerlineup.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetmultiusersplayerbygamedayresponse create(WSDLObjectArrayofarrayofplayerlineup _return) {
		return new WSDLMessageGetmultiusersplayerbygamedayresponse(_return);
	}
}