...
public class WSDLMessageGetplayergamedaystatisticsresponse extends WSDLMessage {

    public final WSDLObjectTradablematchstats field_return;
	
	private WSDLMessageGetplayergamedaystatisticsresponse(WSDLObjectTradablematchstats _return) {
	...
	public static WSDLMessageGetplayergamedaystatisticsresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayergamedaystatisticsResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetplayergamedaystatisticsresponse(WSDLObjectTradablematchstats.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetplayergamedaystatisticsresponse create(WSDLObjectTradablematchstats _return) {
		return new WSDLMessageGetplayergamedaystatisticsresponse(_return);
	}
}