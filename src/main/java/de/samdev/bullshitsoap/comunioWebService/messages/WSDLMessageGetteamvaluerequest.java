...
public class WSDLMessageGetteamvaluerequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	private WSDLMessageGetteamvaluerequest(WSDLObjectInt _userid) {
	...
	public static WSDLMessageGetteamvaluerequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getteamvalueRequest");
		
		Element xml_userid = getFirstChildrenIgnoreNamespace(message, "userid");
		
		return new WSDLMessageGetteamvaluerequest(WSDLObjectInt.createFromXML(xml_userid));
	}
	
	public static WSDLMessageGetteamvaluerequest create(WSDLObjectInt _userid) {
		return new WSDLMessageGetteamvaluerequest(_userid);
	}
}