...
public class WSDLMessageGetuseridsbyplayerrequest extends WSDLMessage {

    public final WSDLObjectInt field_player;
	
	private WSDLMessageGetuseridsbyplayerrequest(WSDLObjectInt _player) {
	...
	public static WSDLMessageGetuseridsbyplayerrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getuseridsbyplayerRequest");
		
		Element xml_player = getFirstChildrenIgnoreNamespace(message, "player");
		
		return new WSDLMessageGetuseridsbyplayerrequest(WSDLObjectInt.createFromXML(xml_player));
	}
	
	public static WSDLMessageGetuseridsbyplayerrequest create(WSDLObjectInt _player) {
		return new WSDLMessageGetuseridsbyplayerrequest(_player);
	}
}