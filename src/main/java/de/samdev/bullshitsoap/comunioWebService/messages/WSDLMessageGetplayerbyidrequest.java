...
public class WSDLMessageGetplayerbyidrequest extends WSDLMessage {
	...
	public static WSDLMessageGetplayerbyidrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayerbyidRequest");
