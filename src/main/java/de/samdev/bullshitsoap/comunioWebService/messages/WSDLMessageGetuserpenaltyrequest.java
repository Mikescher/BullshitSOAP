...
public class WSDLMessageGetuserpenaltyrequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	private WSDLMessageGetuserpenaltyrequest(WSDLObjectInt _userid) {
	...
	public static WSDLMessageGetuserpenaltyrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getuserpenaltyRequest");
		
		Element xml_userid = getFirstChildrenIgnoreNamespace(message, "userid");
		
		return new WSDLMessageGetuserpenaltyrequest(WSDLObjectInt.createFromXML(xml_userid));
	}
	
	public static WSDLMessageGetuserpenaltyrequest create(WSDLObjectInt _userid) {
		return new WSDLMessageGetuserpenaltyrequest(_userid);
	}
}