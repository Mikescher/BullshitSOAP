...
public class WSDLMessageCheckmultipermissionsresponse extends WSDLMessage {

    public final WSDLObjectArrayofplayerstate field_return;
	
	private WSDLMessageCheckmultipermissionsresponse(WSDLObjectArrayofplayerstate _return) {
	...
	public static WSDLMessageCheckmultipermissionsresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "checkmultiPermissionsResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageCheckmultipermissionsresponse(WSDLObjectArrayofplayerstate.createFromXML(xml_return));
	}
	
	public static WSDLMessageCheckmultipermissionsresponse create(WSDLObjectArrayofplayerstate _return) {
		return new WSDLMessageCheckmultipermissionsresponse(_return);
	}
}