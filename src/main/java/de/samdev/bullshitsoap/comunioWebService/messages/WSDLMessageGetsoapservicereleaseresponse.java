...
public class WSDLMessageGetsoapservicereleaseresponse extends WSDLMessage {

    public final WSDLObjectInt field_return;
	
	private WSDLMessageGetsoapservicereleaseresponse(WSDLObjectInt _return) {
	...
	public static WSDLMessageGetsoapservicereleaseresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getsoapservicereleaseResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetsoapservicereleaseresponse(WSDLObjectInt.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetsoapservicereleaseresponse create(WSDLObjectInt _return) {
		return new WSDLMessageGetsoapservicereleaseresponse(_return);
	}
}