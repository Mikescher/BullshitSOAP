...
public class WSDLMessageGetcommunityidresponse extends WSDLMessage {
	...
	public static WSDLMessageGetcommunityidresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getcommunityidResponse");
