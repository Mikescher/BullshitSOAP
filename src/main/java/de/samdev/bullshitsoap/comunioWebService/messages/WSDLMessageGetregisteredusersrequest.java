...
public class WSDLMessageGetregisteredusersrequest extends WSDLMessage {
	
	private WSDLMessageGetregisteredusersrequest() {
	...
	public static WSDLMessageGetregisteredusersrequest createFromXML(Document d) throws IOException {
		return new WSDLMessageGetregisteredusersrequest();
	}
	
	public static WSDLMessageGetregisteredusersrequest create() {
		return new WSDLMessageGetregisteredusersrequest();
	}
}