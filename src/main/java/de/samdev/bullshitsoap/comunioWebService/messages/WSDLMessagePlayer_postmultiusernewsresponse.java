...
public class WSDLMessagePlayer_postmultiusernewsresponse extends WSDLMessage {

    public final WSDLObjectBoolean field_return;
	
	private WSDLMessagePlayer_postmultiusernewsresponse(WSDLObjectBoolean _return) {
	...
	public static WSDLMessagePlayer_postmultiusernewsresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "player_postmultiusernewsResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessagePlayer_postmultiusernewsresponse(WSDLObjectBoolean.createFromXML(xml_return));
	}
	
	public static WSDLMessagePlayer_postmultiusernewsresponse create(WSDLObjectBoolean _return) {
		return new WSDLMessagePlayer_postmultiusernewsresponse(_return);
	}
}