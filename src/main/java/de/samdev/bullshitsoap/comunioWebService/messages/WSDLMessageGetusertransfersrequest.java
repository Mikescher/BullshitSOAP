...
public class WSDLMessageGetusertransfersrequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	public final WSDLObjectInt field_gameday;
	
	private WSDLMessageGetusertransfersrequest(WSDLObjectInt _userid, WSDLObjectInt _gameday) {
	...
	public static WSDLMessageGetusertransfersrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getusertransfersRequest");
		...
		return new WSDLMessageGetusertransfersrequest(WSDLObjectInt.createFromXML(xml_userid), WSDLObjectInt.createFromXML(xml_gameday));
	}
	
	public static WSDLMessageGetusertransfersrequest create(WSDLObjectInt _userid, WSDLObjectInt _gameday) {
		return new WSDLMessageGetusertransfersrequest(_userid, _gameday);
	}
}