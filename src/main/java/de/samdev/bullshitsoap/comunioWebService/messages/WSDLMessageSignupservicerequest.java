...
public class WSDLMessageSignupservicerequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	private WSDLMessageSignupservicerequest(WSDLObjectInt _userid) {
	...
	public static WSDLMessageSignupservicerequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "signupserviceRequest");
		
		Element xml_userid = getFirstChildrenIgnoreNamespace(message, "userid");
		
		return new WSDLMessageSignupservicerequest(WSDLObjectInt.createFromXML(xml_userid));
	}
	
	public static WSDLMessageSignupservicerequest create(WSDLObjectInt _userid) {
		return new WSDLMessageSignupservicerequest(_userid);
	}
}