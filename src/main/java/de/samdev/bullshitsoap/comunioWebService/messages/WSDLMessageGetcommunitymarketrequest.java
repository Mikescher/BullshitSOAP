...
public class WSDLMessageGetcommunitymarketrequest extends WSDLMessage {

    public final WSDLObjectInt field_communityid;
	
	private WSDLMessageGetcommunitymarketrequest(WSDLObjectInt _communityid) {
	...
	public static WSDLMessageGetcommunitymarketrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getcommunitymarketRequest");
		
		Element xml_communityid = getFirstChildrenIgnoreNamespace(message, "communityid");
		
		return new WSDLMessageGetcommunitymarketrequest(WSDLObjectInt.createFromXML(xml_communityid));
	}
	
	public static WSDLMessageGetcommunitymarketrequest create(WSDLObjectInt _communityid) {
		return new WSDLMessageGetcommunitymarketrequest(_communityid);
	}
}