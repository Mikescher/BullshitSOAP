...
public class WSDLMessageGetgamedaysresponse extends WSDLMessage {

    public final WSDLObjectArrayofgamedayitem field_return;
	
	private WSDLMessageGetgamedaysresponse(WSDLObjectArrayofgamedayitem _return) {
	...
	public static WSDLMessageGetgamedaysresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getgamedaysResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetgamedaysresponse(WSDLObjectArrayofgamedayitem.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetgamedaysresponse create(WSDLObjectArrayofgamedayitem _return) {
		return new WSDLMessageGetgamedaysresponse(_return);
	}
}