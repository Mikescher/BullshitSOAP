...
public class WSDLMessageSignupserviceresponse extends WSDLMessage {

    public final WSDLObjectBoolean field_return;
	
	private WSDLMessageSignupserviceresponse(WSDLObjectBoolean _return) {
	...
	public static WSDLMessageSignupserviceresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "signupserviceResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageSignupserviceresponse(WSDLObjectBoolean.createFromXML(xml_return));
	}
	
	public static WSDLMessageSignupserviceresponse create(WSDLObjectBoolean _return) {
		return new WSDLMessageSignupserviceresponse(_return);
	}
}