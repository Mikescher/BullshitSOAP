...
public class WSDLMessageGetusersfirstnameresponse extends WSDLMessage {

    public final WSDLObjectString field_return;
	
	private WSDLMessageGetusersfirstnameresponse(WSDLObjectString _return) {
	...
	public static WSDLMessageGetusersfirstnameresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getusersfirstnameResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetusersfirstnameresponse(WSDLObjectString.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetusersfirstnameresponse create(WSDLObjectString _return) {
		return new WSDLMessageGetusersfirstnameresponse(_return);
	}
}