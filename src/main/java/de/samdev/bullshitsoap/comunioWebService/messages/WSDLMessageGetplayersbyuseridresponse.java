...
public class WSDLMessageGetplayersbyuseridresponse extends WSDLMessage {

    public final WSDLObjectArrayofplayer field_return;
	
	private WSDLMessageGetplayersbyuseridresponse(WSDLObjectArrayofplayer _return) {
	...
	public static WSDLMessageGetplayersbyuseridresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayersbyuseridResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetplayersbyuseridresponse(WSDLObjectArrayofplayer.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetplayersbyuseridresponse create(WSDLObjectArrayofplayer _return) {
		return new WSDLMessageGetplayersbyuseridresponse(_return);
	}
}