...
public class WSDLMessageGetmultiusersgamdaybudgetstateresponse extends WSDLMessage {

    public final WSDLObjectArrayofplayerstate field_return;
	
	private WSDLMessageGetmultiusersgamdaybudgetstateresponse(WSDLObjectArrayofplayerstate _return) {
	...
	public static WSDLMessageGetmultiusersgamdaybudgetstateresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getmultiusersgamdaybudgetstateResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetmultiusersgamdaybudgetstateresponse(WSDLObjectArrayofplayerstate.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetmultiusersgamdaybudgetstateresponse create(WSDLObjectArrayofplayerstate _return) {
		return new WSDLMessageGetmultiusersgamdaybudgetstateresponse(_return);
	}
}