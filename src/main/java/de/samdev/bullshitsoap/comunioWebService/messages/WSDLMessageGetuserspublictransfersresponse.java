...
public class WSDLMessageGetuserspublictransfersresponse extends WSDLMessage {

    public final WSDLObjectArrayoftransferitem field_return;
	
	private WSDLMessageGetuserspublictransfersresponse(WSDLObjectArrayoftransferitem _return) {
	...
	public static WSDLMessageGetuserspublictransfersresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getuserspublictransfersResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetuserspublictransfersresponse(WSDLObjectArrayoftransferitem.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetuserspublictransfersresponse create(WSDLObjectArrayoftransferitem _return) {
		return new WSDLMessageGetuserspublictransfersresponse(_return);
	}
}