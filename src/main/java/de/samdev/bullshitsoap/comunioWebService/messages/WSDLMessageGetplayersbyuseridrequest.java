...
public class WSDLMessageGetplayersbyuseridrequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	private WSDLMessageGetplayersbyuseridrequest(WSDLObjectInt _userid) {
	...
	public static WSDLMessageGetplayersbyuseridrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayersbyuseridRequest");
		
		Element xml_userid = getFirstChildrenIgnoreNamespace(message, "userid");
		
		return new WSDLMessageGetplayersbyuseridrequest(WSDLObjectInt.createFromXML(xml_userid));
	}
	
	public static WSDLMessageGetplayersbyuseridrequest create(WSDLObjectInt _userid) {
		return new WSDLMessageGetplayersbyuseridrequest(_userid);
	}
}