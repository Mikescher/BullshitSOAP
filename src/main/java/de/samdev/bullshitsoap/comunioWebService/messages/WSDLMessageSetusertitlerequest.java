...
public class WSDLMessageSetusertitlerequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	public final WSDLObjectInt field_titleid;
	
	private WSDLMessageSetusertitlerequest(WSDLObjectInt _userid, WSDLObjectInt _titleid) {
	...
	public static WSDLMessageSetusertitlerequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "setusertitleRequest");
		...
		return new WSDLMessageSetusertitlerequest(WSDLObjectInt.createFromXML(xml_userid), WSDLObjectInt.createFromXML(xml_titleid));
	}
	
	public static WSDLMessageSetusertitlerequest create(WSDLObjectInt _userid, WSDLObjectInt _titleid) {
		return new WSDLMessageSetusertitlerequest(_userid, _titleid);
	}
}