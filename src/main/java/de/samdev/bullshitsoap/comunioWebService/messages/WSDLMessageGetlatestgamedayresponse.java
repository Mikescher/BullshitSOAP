...
public class WSDLMessageGetlatestgamedayresponse extends WSDLMessage {

    public final WSDLObjectInt field_return;
	
	private WSDLMessageGetlatestgamedayresponse(WSDLObjectInt _return) {
	...
	public static WSDLMessageGetlatestgamedayresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getlatestgamedayResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetlatestgamedayresponse(WSDLObjectInt.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetlatestgamedayresponse create(WSDLObjectInt _return) {
		return new WSDLMessageGetlatestgamedayresponse(_return);
	}
}