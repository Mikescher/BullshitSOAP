...
public class WSDLMessageDeleteusertitlerequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	public final WSDLObjectInt field_titleid;
	
	private WSDLMessageDeleteusertitlerequest(WSDLObjectInt _userid, WSDLObjectInt _titleid) {
	...
	public static WSDLMessageDeleteusertitlerequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "deleteusertitleRequest");
		...
		return new WSDLMessageDeleteusertitlerequest(WSDLObjectInt.createFromXML(xml_userid), WSDLObjectInt.createFromXML(xml_titleid));
	}
	
	public static WSDLMessageDeleteusertitlerequest create(WSDLObjectInt _userid, WSDLObjectInt _titleid) {
		return new WSDLMessageDeleteusertitlerequest(_userid, _titleid);
	}
}