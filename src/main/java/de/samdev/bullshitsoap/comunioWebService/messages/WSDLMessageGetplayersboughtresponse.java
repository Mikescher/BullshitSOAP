...
public class WSDLMessageGetplayersboughtresponse extends WSDLMessage {

    public final WSDLObjectArrayoftransferitem field_return;
	
	private WSDLMessageGetplayersboughtresponse(WSDLObjectArrayoftransferitem _return) {
	...
	public static WSDLMessageGetplayersboughtresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayersboughtResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetplayersboughtresponse(WSDLObjectArrayoftransferitem.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetplayersboughtresponse create(WSDLObjectArrayoftransferitem _return) {
		return new WSDLMessageGetplayersboughtresponse(_return);
	}
}