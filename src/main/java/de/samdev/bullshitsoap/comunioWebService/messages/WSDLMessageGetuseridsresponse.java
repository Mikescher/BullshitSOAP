...
public class WSDLMessageGetuseridsresponse extends WSDLMessage {

    public final WSDLObjectArrayofuserid field_return;
	
	private WSDLMessageGetuseridsresponse(WSDLObjectArrayofuserid _return) {
	...
	public static WSDLMessageGetuseridsresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getuseridsResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetuseridsresponse(WSDLObjectArrayofuserid.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetuseridsresponse create(WSDLObjectArrayofuserid _return) {
		return new WSDLMessageGetuseridsresponse(_return);
	}
}