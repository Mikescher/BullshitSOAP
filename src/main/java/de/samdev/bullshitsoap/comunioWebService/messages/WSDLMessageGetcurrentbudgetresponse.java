...
public class WSDLMessageGetcurrentbudgetresponse extends WSDLMessage {

    public final WSDLObjectInt field_return;
	
	private WSDLMessageGetcurrentbudgetresponse(WSDLObjectInt _return) {
	...
	public static WSDLMessageGetcurrentbudgetresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getcurrentbudgetResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetcurrentbudgetresponse(WSDLObjectInt.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetcurrentbudgetresponse create(WSDLObjectInt _return) {
		return new WSDLMessageGetcurrentbudgetresponse(_return);
	}
}