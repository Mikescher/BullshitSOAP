...
public class WSDLMessageGetservicerankingrequest extends WSDLMessage {
	
	private WSDLMessageGetservicerankingrequest() {
	...
	public static WSDLMessageGetservicerankingrequest createFromXML(Document d) throws IOException {
		return new WSDLMessageGetservicerankingrequest();
	}
	
	public static WSDLMessageGetservicerankingrequest create() {
		return new WSDLMessageGetservicerankingrequest();
	}
}