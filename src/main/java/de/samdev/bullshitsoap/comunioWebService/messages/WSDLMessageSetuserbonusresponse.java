...
public class WSDLMessageSetuserbonusresponse extends WSDLMessage {

    public final WSDLObjectBoolean field_return;
	
	private WSDLMessageSetuserbonusresponse(WSDLObjectBoolean _return) {
	...
	public static WSDLMessageSetuserbonusresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "setuserbonusResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageSetuserbonusresponse(WSDLObjectBoolean.createFromXML(xml_return));
	}
	
	public static WSDLMessageSetuserbonusresponse create(WSDLObjectBoolean _return) {
		return new WSDLMessageSetuserbonusresponse(_return);
	}
}