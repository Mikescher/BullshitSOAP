...
public class WSDLMessageGetuserslineupbygamedayresponse extends WSDLMessage {

    public final WSDLObjectArrayofplayerlineup field_return;
	
	private WSDLMessageGetuserslineupbygamedayresponse(WSDLObjectArrayofplayerlineup _return) {
	...
	public static WSDLMessageGetuserslineupbygamedayresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getuserslineupbygamedayResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetuserslineupbygamedayresponse(WSDLObjectArrayofplayerlineup.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetuserslineupbygamedayresponse create(WSDLObjectArrayofplayerlineup _return) {
		return new WSDLMessageGetuserslineupbygamedayresponse(_return);
	}
}