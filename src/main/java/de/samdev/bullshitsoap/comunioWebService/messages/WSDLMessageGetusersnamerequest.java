...
public class WSDLMessageGetusersnamerequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	private WSDLMessageGetusersnamerequest(WSDLObjectInt _userid) {
	...
	public static WSDLMessageGetusersnamerequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getusersnameRequest");
		
		Element xml_userid = getFirstChildrenIgnoreNamespace(message, "userid");
		
		return new WSDLMessageGetusersnamerequest(WSDLObjectInt.createFromXML(xml_userid));
	}
	
	public static WSDLMessageGetusersnamerequest create(WSDLObjectInt _userid) {
		return new WSDLMessageGetusersnamerequest(_userid);
	}
}