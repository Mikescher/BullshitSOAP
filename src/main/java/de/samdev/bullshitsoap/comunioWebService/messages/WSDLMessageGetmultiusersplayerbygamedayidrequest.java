...
public class WSDLMessageGetmultiusersplayerbygamedayidrequest extends WSDLMessage {

    public final WSDLObjectArrayofuserid field_arr_userid;
	
	public final WSDLObjectInt field_gameday_id;
	
	private WSDLMessageGetmultiusersplayerbygamedayidrequest(WSDLObjectArrayofuserid _arr_userid, WSDLObjectInt _gameday_id) {
	...
	public static WSDLMessageGetmultiusersplayerbygamedayidrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getmultiusersplayerbygamedayidRequest");
		...
		return new WSDLMessageGetmultiusersplayerbygamedayidrequest(WSDLObjectArrayofuserid.createFromXML(xml_arr_userid), WSDLObjectInt.createFromXML(xml_gameday_id));
	}
	
	public static WSDLMessageGetmultiusersplayerbygamedayidrequest create(WSDLObjectArrayofuserid _arr_userid, WSDLObjectInt _gameday_id) {
		return new WSDLMessageGetmultiusersplayerbygamedayidrequest(_arr_userid, _gameday_id);
	}
}