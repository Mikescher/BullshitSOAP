...
public class WSDLMessageGetplayerbysportaldeidresponse extends WSDLMessage {

    public final WSDLObjectInt field_return;
	
	private WSDLMessageGetplayerbysportaldeidresponse(WSDLObjectInt _return) {
	...
	public static WSDLMessageGetplayerbysportaldeidresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayerbysportaldeidResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetplayerbysportaldeidresponse(WSDLObjectInt.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetplayerbysportaldeidresponse create(WSDLObjectInt _return) {
		return new WSDLMessageGetplayerbysportaldeidresponse(_return);
	}
}