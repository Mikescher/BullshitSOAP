...
public class WSDLMessagePostmultiusernewsresponse extends WSDLMessage {

    public final WSDLObjectBoolean field_return;
	
	private WSDLMessagePostmultiusernewsresponse(WSDLObjectBoolean _return) {
	...
	public static WSDLMessagePostmultiusernewsresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "postmultiusernewsResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessagePostmultiusernewsresponse(WSDLObjectBoolean.createFromXML(xml_return));
	}
	
	public static WSDLMessagePostmultiusernewsresponse create(WSDLObjectBoolean _return) {
		return new WSDLMessagePostmultiusernewsresponse(_return);
	}
}