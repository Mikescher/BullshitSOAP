...
public class WSDLMessageGetplayersinfobyuseridresponse extends WSDLMessage {

    public final WSDLObjectArrayofplayerinfo field_return;
	
	private WSDLMessageGetplayersinfobyuseridresponse(WSDLObjectArrayofplayerinfo _return) {
	...
	public static WSDLMessageGetplayersinfobyuseridresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayersinfobyuseridResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetplayersinfobyuseridresponse(WSDLObjectArrayofplayerinfo.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetplayersinfobyuseridresponse create(WSDLObjectArrayofplayerinfo _return) {
		return new WSDLMessageGetplayersinfobyuseridresponse(_return);
	}
}