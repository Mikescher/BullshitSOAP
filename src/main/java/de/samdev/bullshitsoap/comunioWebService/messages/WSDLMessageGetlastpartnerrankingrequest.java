...
public class WSDLMessageGetlastpartnerrankingrequest extends WSDLMessage {
	
	private WSDLMessageGetlastpartnerrankingrequest() {
	...
	public static WSDLMessageGetlastpartnerrankingrequest createFromXML(Document d) throws IOException {
		return new WSDLMessageGetlastpartnerrankingrequest();
	}
	
	public static WSDLMessageGetlastpartnerrankingrequest create() {
		return new WSDLMessageGetlastpartnerrankingrequest();
	}
}