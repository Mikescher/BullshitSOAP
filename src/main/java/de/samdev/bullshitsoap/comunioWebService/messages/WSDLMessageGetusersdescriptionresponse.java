...
public class WSDLMessageGetusersdescriptionresponse extends WSDLMessage {

    public final WSDLObjectString field_return;
	
	private WSDLMessageGetusersdescriptionresponse(WSDLObjectString _return) {
	...
	public static WSDLMessageGetusersdescriptionresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getusersdescriptionResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetusersdescriptionresponse(WSDLObjectString.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetusersdescriptionresponse create(WSDLObjectString _return) {
		return new WSDLMessageGetusersdescriptionresponse(_return);
	}
}