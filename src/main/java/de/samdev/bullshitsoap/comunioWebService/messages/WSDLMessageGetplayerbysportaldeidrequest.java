...
public class WSDLMessageGetplayerbysportaldeidrequest extends WSDLMessage {
	...
	public static WSDLMessageGetplayerbysportaldeidrequest createFromXML(Document d) throws IOException {
		...
		Element xml_sportaldeid = message.getFirstChildElement("sportaldeid");
