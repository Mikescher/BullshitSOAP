...
public class WSDLMessageGetplayerbysportaldeidrequest extends WSDLMessage {

    public final WSDLObjectInt field_sportaldeid;
	
	private WSDLMessageGetplayerbysportaldeidrequest(WSDLObjectInt _sportaldeid) {
		super(WSDLNamespaceCollection.NAMESPACE_PATH_SERVICE_BASE);
		
		field_sportaldeid = _sportaldeid;
	}
	...
	public Document serialize(String opname) {
		...
		message.appendChild(field_sportaldeid.serialize("sportaldeid"));
	...
	public static WSDLMessageGetplayerbysportaldeidrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayerbysportaldeidRequest");
		
		Element xml_sportaldeid = getFirstChildrenIgnoreNamespace(message, "sportaldeid");
		
		return new WSDLMessageGetplayerbysportaldeidrequest(WSDLObjectInt.createFromXML(xml_sportaldeid));
	}
	
	public static WSDLMessageGetplayerbysportaldeidrequest create(WSDLObjectInt _sportaldeid) {
		return new WSDLMessageGetplayerbysportaldeidrequest(_sportaldeid);
	}
}