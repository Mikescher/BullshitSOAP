...
public class WSDLMessageGetuserscurrentlineupresponse extends WSDLMessage {

    public final WSDLObjectArrayofplayerlineup field_return;
	
	private WSDLMessageGetuserscurrentlineupresponse(WSDLObjectArrayofplayerlineup _return) {
	...
	public static WSDLMessageGetuserscurrentlineupresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getuserscurrentlineupResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetuserscurrentlineupresponse(WSDLObjectArrayofplayerlineup.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetuserscurrentlineupresponse create(WSDLObjectArrayofplayerlineup _return) {
		return new WSDLMessageGetuserscurrentlineupresponse(_return);
	}
}