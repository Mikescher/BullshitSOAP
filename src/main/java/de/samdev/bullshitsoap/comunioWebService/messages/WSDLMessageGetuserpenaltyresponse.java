...
public class WSDLMessageGetuserpenaltyresponse extends WSDLMessage {

    public final WSDLObjectInt field_return;
	
	private WSDLMessageGetuserpenaltyresponse(WSDLObjectInt _return) {
	...
	public static WSDLMessageGetuserpenaltyresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getuserpenaltyResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetuserpenaltyresponse(WSDLObjectInt.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetuserpenaltyresponse create(WSDLObjectInt _return) {
		return new WSDLMessageGetuserpenaltyresponse(_return);
	}
}