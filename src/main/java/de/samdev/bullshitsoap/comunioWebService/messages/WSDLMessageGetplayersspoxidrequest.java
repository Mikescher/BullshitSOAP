...
public class WSDLMessageGetplayersspoxidrequest extends WSDLMessage {

    public final WSDLObjectInt field_playerid;
	
	private WSDLMessageGetplayersspoxidrequest(WSDLObjectInt _playerid) {
	...
	public static WSDLMessageGetplayersspoxidrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayersspoxidRequest");
		
		Element xml_playerid = getFirstChildrenIgnoreNamespace(message, "playerid");
		
		return new WSDLMessageGetplayersspoxidrequest(WSDLObjectInt.createFromXML(xml_playerid));
	}
	
	public static WSDLMessageGetplayersspoxidrequest create(WSDLObjectInt _playerid) {
		return new WSDLMessageGetplayersspoxidrequest(_playerid);
	}
}