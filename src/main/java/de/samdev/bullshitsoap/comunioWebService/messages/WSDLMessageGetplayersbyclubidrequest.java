...
public class WSDLMessageGetplayersbyclubidrequest extends WSDLMessage {
	...
	public static WSDLMessageGetplayersbyclubidrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayersbyclubidRequest");
