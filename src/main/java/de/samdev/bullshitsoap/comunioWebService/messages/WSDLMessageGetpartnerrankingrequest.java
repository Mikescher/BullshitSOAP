...
public class WSDLMessageGetpartnerrankingrequest extends WSDLMessage {
	
	private WSDLMessageGetpartnerrankingrequest() {
	...
	public static WSDLMessageGetpartnerrankingrequest createFromXML(Document d) throws IOException {
		return new WSDLMessageGetpartnerrankingrequest();
	}
	
	public static WSDLMessageGetpartnerrankingrequest create() {
		return new WSDLMessageGetpartnerrankingrequest();
	}
}