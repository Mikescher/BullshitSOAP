...
public class WSDLMessageGetusergamedaypointsidrequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	public final WSDLObjectInt field_gameday_id;
	
	private WSDLMessageGetusergamedaypointsidrequest(WSDLObjectInt _userid, WSDLObjectInt _gameday_id) {
	...
	public static WSDLMessageGetusergamedaypointsidrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getusergamedaypointsidRequest");
		...
		return new WSDLMessageGetusergamedaypointsidrequest(WSDLObjectInt.createFromXML(xml_userid), WSDLObjectInt.createFromXML(xml_gameday_id));
	}
	
	public static WSDLMessageGetusergamedaypointsidrequest create(WSDLObjectInt _userid, WSDLObjectInt _gameday_id) {
		return new WSDLMessageGetusergamedaypointsidrequest(_userid, _gameday_id);
	}
}