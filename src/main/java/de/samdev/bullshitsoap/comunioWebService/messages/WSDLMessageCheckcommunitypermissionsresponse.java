...
public class WSDLMessageCheckcommunitypermissionsresponse extends WSDLMessage {

    public final WSDLObjectBoolean field_return;
	
	private WSDLMessageCheckcommunitypermissionsresponse(WSDLObjectBoolean _return) {
	...
	public static WSDLMessageCheckcommunitypermissionsresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "checkcommunitypermissionsResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageCheckcommunitypermissionsresponse(WSDLObjectBoolean.createFromXML(xml_return));
	}
	
	public static WSDLMessageCheckcommunitypermissionsresponse create(WSDLObjectBoolean _return) {
		return new WSDLMessageCheckcommunitypermissionsresponse(_return);
	}
}