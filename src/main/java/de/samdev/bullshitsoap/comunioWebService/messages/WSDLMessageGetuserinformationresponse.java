...
public class WSDLMessageGetuserinformationresponse extends WSDLMessage {

    public final WSDLObjectUseritem field_return;
	
	private WSDLMessageGetuserinformationresponse(WSDLObjectUseritem _return) {
	...
	public static WSDLMessageGetuserinformationresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getUserInformationResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetuserinformationresponse(WSDLObjectUseritem.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetuserinformationresponse create(WSDLObjectUseritem _return) {
		return new WSDLMessageGetuserinformationresponse(_return);
	}
}