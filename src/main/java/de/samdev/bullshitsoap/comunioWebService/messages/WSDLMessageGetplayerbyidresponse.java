...
public class WSDLMessageGetplayerbyidresponse extends WSDLMessage {

    public final WSDLObjectPlayer field_return;
	
	private WSDLMessageGetplayerbyidresponse(WSDLObjectPlayer _return) {
	...
	public static WSDLMessageGetplayerbyidresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayerbyidResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetplayerbyidresponse(WSDLObjectPlayer.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetplayerbyidresponse create(WSDLObjectPlayer _return) {
		return new WSDLMessageGetplayerbyidresponse(_return);
	}
}