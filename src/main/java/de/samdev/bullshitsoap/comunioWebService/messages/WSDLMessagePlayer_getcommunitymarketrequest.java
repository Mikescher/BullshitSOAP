...
public class WSDLMessagePlayer_getcommunitymarketrequest extends WSDLMessage {
	
	private WSDLMessagePlayer_getcommunitymarketrequest() {
	...
	public Document serialize() {
		...
		body.appendChild(new Element("%MESSAGENAME%"));
	...
	public static WSDLMessagePlayer_getcommunitymarketrequest createFromXML(Document d) throws IOException {
		return new WSDLMessagePlayer_getcommunitymarketrequest();
	}
	
	public static WSDLMessagePlayer_getcommunitymarketrequest create() {
		return new WSDLMessagePlayer_getcommunitymarketrequest();
	}
}