...
public class WSDLMessageGetplayerssportaldeidrequest extends WSDLMessage {

    public final WSDLObjectInt field_playerid;
	
	private WSDLMessageGetplayerssportaldeidrequest(WSDLObjectInt _playerid) {
	...
	public static WSDLMessageGetplayerssportaldeidrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayerssportaldeidRequest");
		
		Element xml_playerid = getFirstChildrenIgnoreNamespace(message, "playerid");
		
		return new WSDLMessageGetplayerssportaldeidrequest(WSDLObjectInt.createFromXML(xml_playerid));
	}
	
	public static WSDLMessageGetplayerssportaldeidrequest create(WSDLObjectInt _playerid) {
		return new WSDLMessageGetplayerssportaldeidrequest(_playerid);
	}
}