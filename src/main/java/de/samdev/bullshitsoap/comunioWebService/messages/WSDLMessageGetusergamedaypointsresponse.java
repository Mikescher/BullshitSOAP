...
public class WSDLMessageGetusergamedaypointsresponse extends WSDLMessage {

    public final WSDLObjectInt field_return;
	
	private WSDLMessageGetusergamedaypointsresponse(WSDLObjectInt _return) {
	...
	public static WSDLMessageGetusergamedaypointsresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getusergamedaypointsResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetusergamedaypointsresponse(WSDLObjectInt.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetusergamedaypointsresponse create(WSDLObjectInt _return) {
		return new WSDLMessageGetusergamedaypointsresponse(_return);
	}
}