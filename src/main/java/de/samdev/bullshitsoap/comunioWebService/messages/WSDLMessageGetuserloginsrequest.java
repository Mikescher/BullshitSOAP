...
public class WSDLMessageGetuserloginsrequest extends WSDLMessage {

    public final WSDLObjectInt field_communityid;
	
	private WSDLMessageGetuserloginsrequest(WSDLObjectInt _communityid) {
	...
	public static WSDLMessageGetuserloginsrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getuserloginsRequest");
		
		Element xml_communityid = getFirstChildrenIgnoreNamespace(message, "communityid");
		
		return new WSDLMessageGetuserloginsrequest(WSDLObjectInt.createFromXML(xml_communityid));
	}
	
	public static WSDLMessageGetuserloginsrequest create(WSDLObjectInt _communityid) {
		return new WSDLMessageGetuserloginsrequest(_communityid);
	}
}