...
public class WSDLMessageCheckpermissionsresponse extends WSDLMessage {

    public final WSDLObjectBoolean field_return;
	
	private WSDLMessageCheckpermissionsresponse(WSDLObjectBoolean _return) {
	...
	public static WSDLMessageCheckpermissionsresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "checkPermissionsResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageCheckpermissionsresponse(WSDLObjectBoolean.createFromXML(xml_return));
	}
	
	public static WSDLMessageCheckpermissionsresponse create(WSDLObjectBoolean _return) {
		return new WSDLMessageCheckpermissionsresponse(_return);
	}
}