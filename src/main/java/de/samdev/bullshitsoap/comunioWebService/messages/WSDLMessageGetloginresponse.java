...
public class WSDLMessageGetloginresponse extends WSDLMessage {

    public final WSDLObjectString field_return;
	
	private WSDLMessageGetloginresponse(WSDLObjectString _return) {
	...
	public static WSDLMessageGetloginresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getloginResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetloginresponse(WSDLObjectString.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetloginresponse create(WSDLObjectString _return) {
		return new WSDLMessageGetloginresponse(_return);
	}
}