...
public class WSDLMessageGetcommunityadminsrequest extends WSDLMessage {

    public final WSDLObjectInt field_communityid;
	
	private WSDLMessageGetcommunityadminsrequest(WSDLObjectInt _communityid) {
	...
	public static WSDLMessageGetcommunityadminsrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getcommunityadminsRequest");
		
		Element xml_communityid = getFirstChildrenIgnoreNamespace(message, "communityid");
		
		return new WSDLMessageGetcommunityadminsrequest(WSDLObjectInt.createFromXML(xml_communityid));
	}
	
	public static WSDLMessageGetcommunityadminsrequest create(WSDLObjectInt _communityid) {
		return new WSDLMessageGetcommunityadminsrequest(_communityid);
	}
}