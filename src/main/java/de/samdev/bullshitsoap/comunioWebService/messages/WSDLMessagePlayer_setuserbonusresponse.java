...
public class WSDLMessagePlayer_setuserbonusresponse extends WSDLMessage {

    public final WSDLObjectBoolean field_return;
	
	private WSDLMessagePlayer_setuserbonusresponse(WSDLObjectBoolean _return) {
	...
	public static WSDLMessagePlayer_setuserbonusresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "player_setuserbonusResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessagePlayer_setuserbonusresponse(WSDLObjectBoolean.createFromXML(xml_return));
	}
	
	public static WSDLMessagePlayer_setuserbonusresponse create(WSDLObjectBoolean _return) {
		return new WSDLMessagePlayer_setuserbonusresponse(_return);
	}
}