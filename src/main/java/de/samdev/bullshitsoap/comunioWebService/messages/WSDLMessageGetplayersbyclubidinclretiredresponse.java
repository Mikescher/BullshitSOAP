...
public class WSDLMessageGetplayersbyclubidinclretiredresponse extends WSDLMessage {

    public final WSDLObjectArrayofplayer field_return;
	
	private WSDLMessageGetplayersbyclubidinclretiredresponse(WSDLObjectArrayofplayer _return) {
	...
	public static WSDLMessageGetplayersbyclubidinclretiredresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayersbyclubidinclretiredResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetplayersbyclubidinclretiredresponse(WSDLObjectArrayofplayer.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetplayersbyclubidinclretiredresponse create(WSDLObjectArrayofplayer _return) {
		return new WSDLMessageGetplayersbyclubidinclretiredresponse(_return);
	}
}