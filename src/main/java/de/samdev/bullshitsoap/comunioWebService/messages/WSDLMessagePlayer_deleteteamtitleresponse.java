...
public class WSDLMessagePlayer_deleteteamtitleresponse extends WSDLMessage {

    public final WSDLObjectBoolean field_return;
	
	private WSDLMessagePlayer_deleteteamtitleresponse(WSDLObjectBoolean _return) {
	...
	public static WSDLMessagePlayer_deleteteamtitleresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "player_deleteteamtitleResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessagePlayer_deleteteamtitleresponse(WSDLObjectBoolean.createFromXML(xml_return));
	}
	
	public static WSDLMessagePlayer_deleteteamtitleresponse create(WSDLObjectBoolean _return) {
		return new WSDLMessagePlayer_deleteteamtitleresponse(_return);
	}
}