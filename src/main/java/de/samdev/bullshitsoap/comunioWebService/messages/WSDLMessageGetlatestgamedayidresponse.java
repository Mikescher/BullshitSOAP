...
public class WSDLMessageGetlatestgamedayidresponse extends WSDLMessage {

    public final WSDLObjectInt field_return;
	
	private WSDLMessageGetlatestgamedayidresponse(WSDLObjectInt _return) {
	...
	public static WSDLMessageGetlatestgamedayidresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getlatestgamedayidResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetlatestgamedayidresponse(WSDLObjectInt.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetlatestgamedayidresponse create(WSDLObjectInt _return) {
		return new WSDLMessageGetlatestgamedayidresponse(_return);
	}
}