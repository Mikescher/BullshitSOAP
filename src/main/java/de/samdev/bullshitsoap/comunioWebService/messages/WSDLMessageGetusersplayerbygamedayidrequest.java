...
public class WSDLMessageGetusersplayerbygamedayidrequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	public final WSDLObjectInt field_gameday_id;
	
	private WSDLMessageGetusersplayerbygamedayidrequest(WSDLObjectInt _userid, WSDLObjectInt _gameday_id) {
	...
	public static WSDLMessageGetusersplayerbygamedayidrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getusersplayerbygamedayidRequest");
		...
		return new WSDLMessageGetusersplayerbygamedayidrequest(WSDLObjectInt.createFromXML(xml_userid), WSDLObjectInt.createFromXML(xml_gameday_id));
	}
	
	public static WSDLMessageGetusersplayerbygamedayidrequest create(WSDLObjectInt _userid, WSDLObjectInt _gameday_id) {
		return new WSDLMessageGetusersplayerbygamedayidrequest(_userid, _gameday_id);
	}
}