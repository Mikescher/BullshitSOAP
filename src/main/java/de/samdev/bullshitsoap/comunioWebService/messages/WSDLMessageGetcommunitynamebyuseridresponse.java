...
public class WSDLMessageGetcommunitynamebyuseridresponse extends WSDLMessage {

    public final WSDLObjectString field_return;
	
	private WSDLMessageGetcommunitynamebyuseridresponse(WSDLObjectString _return) {
	...
	public static WSDLMessageGetcommunitynamebyuseridresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getcommunitynamebyuseridResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetcommunitynamebyuseridresponse(WSDLObjectString.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetcommunitynamebyuseridresponse create(WSDLObjectString _return) {
		return new WSDLMessageGetcommunitynamebyuseridresponse(_return);
	}
}