...
public class WSDLMessageGetcurrentbudgetrequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	private WSDLMessageGetcurrentbudgetrequest(WSDLObjectInt _userid) {
	...
	public static WSDLMessageGetcurrentbudgetrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getcurrentbudgetRequest");
		
		Element xml_userid = getFirstChildrenIgnoreNamespace(message, "userid");
		
		return new WSDLMessageGetcurrentbudgetrequest(WSDLObjectInt.createFromXML(xml_userid));
	}
	
	public static WSDLMessageGetcurrentbudgetrequest create(WSDLObjectInt _userid) {
		return new WSDLMessageGetcurrentbudgetrequest(_userid);
	}
}