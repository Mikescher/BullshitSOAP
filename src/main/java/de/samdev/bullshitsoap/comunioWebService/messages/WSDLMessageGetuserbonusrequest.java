...
public class WSDLMessageGetuserbonusrequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	private WSDLMessageGetuserbonusrequest(WSDLObjectInt _userid) {
	...
	public static WSDLMessageGetuserbonusrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getuserbonusRequest");
		
		Element xml_userid = getFirstChildrenIgnoreNamespace(message, "userid");
		
		return new WSDLMessageGetuserbonusrequest(WSDLObjectInt.createFromXML(xml_userid));
	}
	
	public static WSDLMessageGetuserbonusrequest create(WSDLObjectInt _userid) {
		return new WSDLMessageGetuserbonusrequest(_userid);
	}
}