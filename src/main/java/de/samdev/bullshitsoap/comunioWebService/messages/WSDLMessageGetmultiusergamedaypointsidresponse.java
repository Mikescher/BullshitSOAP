...
public class WSDLMessageGetmultiusergamedaypointsidresponse extends WSDLMessage {

    public final WSDLObjectArrayofplayerpoints field_return;
	
	private WSDLMessageGetmultiusergamedaypointsidresponse(WSDLObjectArrayofplayerpoints _return) {
	...
	public static WSDLMessageGetmultiusergamedaypointsidresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getmultiusergamedaypointsidResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetmultiusergamedaypointsidresponse(WSDLObjectArrayofplayerpoints.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetmultiusergamedaypointsidresponse create(WSDLObjectArrayofplayerpoints _return) {
		return new WSDLMessageGetmultiusergamedaypointsidresponse(_return);
	}
}