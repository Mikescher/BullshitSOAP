...
public class WSDLMessageGetplayerssoldrequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	public final WSDLObjectInt field_gameday;
	
	private WSDLMessageGetplayerssoldrequest(WSDLObjectInt _userid, WSDLObjectInt _gameday) {
	...
	public static WSDLMessageGetplayerssoldrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayerssoldRequest");
		...
		return new WSDLMessageGetplayerssoldrequest(WSDLObjectInt.createFromXML(xml_userid), WSDLObjectInt.createFromXML(xml_gameday));
	}
	
	public static WSDLMessageGetplayerssoldrequest create(WSDLObjectInt _userid, WSDLObjectInt _gameday) {
		return new WSDLMessageGetplayerssoldrequest(_userid, _gameday);
	}
}