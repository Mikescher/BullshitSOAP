...
public class WSDLMessageGetteamvalueresponse extends WSDLMessage {

    public final WSDLObjectInt field_return;
	
	private WSDLMessageGetteamvalueresponse(WSDLObjectInt _return) {
	...
	public static WSDLMessageGetteamvalueresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getteamvalueResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetteamvalueresponse(WSDLObjectInt.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetteamvalueresponse create(WSDLObjectInt _return) {
		return new WSDLMessageGetteamvalueresponse(_return);
	}
}