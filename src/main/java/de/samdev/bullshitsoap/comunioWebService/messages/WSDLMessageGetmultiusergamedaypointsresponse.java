...
public class WSDLMessageGetmultiusergamedaypointsresponse extends WSDLMessage {

    public final WSDLObjectArrayofplayerpoints field_return;
	
	private WSDLMessageGetmultiusergamedaypointsresponse(WSDLObjectArrayofplayerpoints _return) {
	...
	public static WSDLMessageGetmultiusergamedaypointsresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getmultiusergamedaypointsResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetmultiusergamedaypointsresponse(WSDLObjectArrayofplayerpoints.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetmultiusergamedaypointsresponse create(WSDLObjectArrayofplayerpoints _return) {
		return new WSDLMessageGetmultiusergamedaypointsresponse(_return);
	}
}