...
public class WSDLMessageGetplayersspoxidresponse extends WSDLMessage {

    public final WSDLObjectInt field_return;
	
	private WSDLMessageGetplayersspoxidresponse(WSDLObjectInt _return) {
	...
	public static WSDLMessageGetplayersspoxidresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayersspoxidResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetplayersspoxidresponse(WSDLObjectInt.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetplayersspoxidresponse create(WSDLObjectInt _return) {
		return new WSDLMessageGetplayersspoxidresponse(_return);
	}
}