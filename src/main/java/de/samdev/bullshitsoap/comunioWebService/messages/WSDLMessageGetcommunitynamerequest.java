...
public class WSDLMessageGetcommunitynamerequest extends WSDLMessage {

    public final WSDLObjectInt field_communityid;
	
	private WSDLMessageGetcommunitynamerequest(WSDLObjectInt _communityid) {
	...
	public static WSDLMessageGetcommunitynamerequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getcommunitynameRequest");
		
		Element xml_communityid = getFirstChildrenIgnoreNamespace(message, "communityid");
		
		return new WSDLMessageGetcommunitynamerequest(WSDLObjectInt.createFromXML(xml_communityid));
	}
	
	public static WSDLMessageGetcommunitynamerequest create(WSDLObjectInt _communityid) {
		return new WSDLMessageGetcommunitynamerequest(_communityid);
	}
}