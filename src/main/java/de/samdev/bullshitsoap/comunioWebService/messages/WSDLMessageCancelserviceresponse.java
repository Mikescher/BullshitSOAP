...
public class WSDLMessageCancelserviceresponse extends WSDLMessage {

    public final WSDLObjectBoolean field_return;
	
	private WSDLMessageCancelserviceresponse(WSDLObjectBoolean _return) {
	...
	public static WSDLMessageCancelserviceresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "cancelserviceResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageCancelserviceresponse(WSDLObjectBoolean.createFromXML(xml_return));
	}
	
	public static WSDLMessageCancelserviceresponse create(WSDLObjectBoolean _return) {
		return new WSDLMessageCancelserviceresponse(_return);
	}
}