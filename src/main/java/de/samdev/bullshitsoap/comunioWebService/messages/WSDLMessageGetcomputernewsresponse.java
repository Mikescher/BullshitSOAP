...
public class WSDLMessageGetcomputernewsresponse extends WSDLMessage {

    public final WSDLObjectArrayofnewsitem field_return;
	
	private WSDLMessageGetcomputernewsresponse(WSDLObjectArrayofnewsitem _return) {
	...
	public static WSDLMessageGetcomputernewsresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getcomputernewsResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetcomputernewsresponse(WSDLObjectArrayofnewsitem.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetcomputernewsresponse create(WSDLObjectArrayofnewsitem _return) {
		return new WSDLMessageGetcomputernewsresponse(_return);
	}
}