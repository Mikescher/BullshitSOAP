...
public class WSDLMessageGetmultiusersplayerbygamedayrequest extends WSDLMessage {

    public final WSDLObjectArrayofuserid field_arr_userid;
	
	public final WSDLObjectInt field_gameday;
	
	private WSDLMessageGetmultiusersplayerbygamedayrequest(WSDLObjectArrayofuserid _arr_userid, WSDLObjectInt _gameday) {
	...
	public static WSDLMessageGetmultiusersplayerbygamedayrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getmultiusersplayerbygamedayRequest");
		
		Element xml_arr_userid = getFirstChildrenIgnoreNamespace(message, "arr_userid");
		Element xml_gameday = getFirstChildrenIgnoreNamespace(message, "gameday");
		
		return new WSDLMessageGetmultiusersplayerbygamedayrequest(WSDLObjectArrayofuserid.createFromXML(xml_arr_userid), WSDLObjectInt.createFromXML(xml_gameday));
	}
	
	public static WSDLMessageGetmultiusersplayerbygamedayrequest create(WSDLObjectArrayofuserid _arr_userid, WSDLObjectInt _gameday) {
		return new WSDLMessageGetmultiusersplayerbygamedayrequest(_arr_userid, _gameday);
	}
}