...
public class WSDLMessageGetquoteresponse extends WSDLMessage {

    public final WSDLObjectInt field_return;
	
	private WSDLMessageGetquoteresponse(WSDLObjectInt _return) {
	...
	public static WSDLMessageGetquoteresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getquoteResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetquoteresponse(WSDLObjectInt.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetquoteresponse create(WSDLObjectInt _return) {
		return new WSDLMessageGetquoteresponse(_return);
	}
}