...
public class WSDLMessageGetclubsresponse extends WSDLMessage {

    public final WSDLObjectArrayofclub field_return;
	
	private WSDLMessageGetclubsresponse(WSDLObjectArrayofclub _return) {
	...
	public static WSDLMessageGetclubsresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getclubsResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetclubsresponse(WSDLObjectArrayofclub.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetclubsresponse create(WSDLObjectArrayofclub _return) {
		return new WSDLMessageGetclubsresponse(_return);
	}
}