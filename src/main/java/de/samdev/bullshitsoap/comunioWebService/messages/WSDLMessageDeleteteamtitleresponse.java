...
public class WSDLMessageDeleteteamtitleresponse extends WSDLMessage {

    public final WSDLObjectBoolean field_return;
	
	private WSDLMessageDeleteteamtitleresponse(WSDLObjectBoolean _return) {
	...
	public static WSDLMessageDeleteteamtitleresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "deleteteamtitleResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageDeleteteamtitleresponse(WSDLObjectBoolean.createFromXML(xml_return));
	}
	
	public static WSDLMessageDeleteteamtitleresponse create(WSDLObjectBoolean _return) {
		return new WSDLMessageDeleteteamtitleresponse(_return);
	}
}