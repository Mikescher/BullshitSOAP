...
public class WSDLMessagePostusernewsresponse extends WSDLMessage {

    public final WSDLObjectBoolean field_return;
	
	private WSDLMessagePostusernewsresponse(WSDLObjectBoolean _return) {
	...
	public static WSDLMessagePostusernewsresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "postusernewsResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessagePostusernewsresponse(WSDLObjectBoolean.createFromXML(xml_return));
	}
	
	public static WSDLMessagePostusernewsresponse create(WSDLObjectBoolean _return) {
		return new WSDLMessagePostusernewsresponse(_return);
	}
}