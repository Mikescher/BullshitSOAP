...
public class WSDLMessageGetuserspublictransfersrequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	public final WSDLObjectInt field_gameday;
	
	private WSDLMessageGetuserspublictransfersrequest(WSDLObjectInt _userid, WSDLObjectInt _gameday) {
	...
	public static WSDLMessageGetuserspublictransfersrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getuserspublictransfersRequest");
		...
		return new WSDLMessageGetuserspublictransfersrequest(WSDLObjectInt.createFromXML(xml_userid), WSDLObjectInt.createFromXML(xml_gameday));
	}
	
	public static WSDLMessageGetuserspublictransfersrequest create(WSDLObjectInt _userid, WSDLObjectInt _gameday) {
		return new WSDLMessageGetuserspublictransfersrequest(_userid, _gameday);
	}
}