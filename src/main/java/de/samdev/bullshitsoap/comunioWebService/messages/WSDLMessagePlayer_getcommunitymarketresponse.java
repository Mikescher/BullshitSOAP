...
public class WSDLMessagePlayer_getcommunitymarketresponse extends WSDLMessage {

    public final WSDLObjectArrayofplayerexchangemarket field_return;
	
	private WSDLMessagePlayer_getcommunitymarketresponse(WSDLObjectArrayofplayerexchangemarket _return) {
	...
	public static WSDLMessagePlayer_getcommunitymarketresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "player_getcommunitymarketResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessagePlayer_getcommunitymarketresponse(WSDLObjectArrayofplayerexchangemarket.createFromXML(xml_return));
	}
	
	public static WSDLMessagePlayer_getcommunitymarketresponse create(WSDLObjectArrayofplayerexchangemarket _return) {
		return new WSDLMessagePlayer_getcommunitymarketresponse(_return);
	}
}