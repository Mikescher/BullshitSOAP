...
public class WSDLMessagePostadminnewsresponse extends WSDLMessage {

    public final WSDLObjectBoolean field_return;
	
	private WSDLMessagePostadminnewsresponse(WSDLObjectBoolean _return) {
	...
	public static WSDLMessagePostadminnewsresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "postadminnewsResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessagePostadminnewsresponse(WSDLObjectBoolean.createFromXML(xml_return));
	}
	
	public static WSDLMessagePostadminnewsresponse create(WSDLObjectBoolean _return) {
		return new WSDLMessagePostadminnewsresponse(_return);
	}
}