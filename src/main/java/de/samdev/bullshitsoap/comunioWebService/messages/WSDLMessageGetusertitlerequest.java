...
public class WSDLMessageGetusertitlerequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	private WSDLMessageGetusertitlerequest(WSDLObjectInt _userid) {
	...
	public static WSDLMessageGetusertitlerequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getusertitleRequest");
		
		Element xml_userid = getFirstChildrenIgnoreNamespace(message, "userid");
		
		return new WSDLMessageGetusertitlerequest(WSDLObjectInt.createFromXML(xml_userid));
	}
	
	public static WSDLMessageGetusertitlerequest create(WSDLObjectInt _userid) {
		return new WSDLMessageGetusertitlerequest(_userid);
	}
}