...
public class WSDLMessageGetuseridsbyplayerresponse extends WSDLMessage {

    public final WSDLObjectArrayofuserid field_return;
	
	private WSDLMessageGetuseridsbyplayerresponse(WSDLObjectArrayofuserid _return) {
	...
	public static WSDLMessageGetuseridsbyplayerresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getuseridsbyplayerResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetuseridsbyplayerresponse(WSDLObjectArrayofuserid.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetuseridsbyplayerresponse create(WSDLObjectArrayofuserid _return) {
		return new WSDLMessageGetuseridsbyplayerresponse(_return);
	}
}