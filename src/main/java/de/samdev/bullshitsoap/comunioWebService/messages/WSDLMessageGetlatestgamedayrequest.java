...
public class WSDLMessageGetlatestgamedayrequest extends WSDLMessage {
	
	private WSDLMessageGetlatestgamedayrequest() {
	...
	public static WSDLMessageGetlatestgamedayrequest createFromXML(Document d) throws IOException {
		return new WSDLMessageGetlatestgamedayrequest();
	}
	
	public static WSDLMessageGetlatestgamedayrequest create() {
		return new WSDLMessageGetlatestgamedayrequest();
	}
}