...
public class WSDLMessageGetlatestgamedayidrequest extends WSDLMessage {
	
	private WSDLMessageGetlatestgamedayidrequest() {
	...
	public static WSDLMessageGetlatestgamedayidrequest createFromXML(Document d) throws IOException {
		return new WSDLMessageGetlatestgamedayidrequest();
	}
	
	public static WSDLMessageGetlatestgamedayidrequest create() {
		return new WSDLMessageGetlatestgamedayidrequest();
	}
}