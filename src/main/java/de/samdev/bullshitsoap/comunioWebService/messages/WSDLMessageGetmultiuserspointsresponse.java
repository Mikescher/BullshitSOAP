...
public class WSDLMessageGetmultiuserspointsresponse extends WSDLMessage {

    public final WSDLObjectArrayofplayerpoints field_return;
	
	private WSDLMessageGetmultiuserspointsresponse(WSDLObjectArrayofplayerpoints _return) {
	...
	public static WSDLMessageGetmultiuserspointsresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getmultiuserspointsResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetmultiuserspointsresponse(WSDLObjectArrayofplayerpoints.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetmultiuserspointsresponse create(WSDLObjectArrayofplayerpoints _return) {
		return new WSDLMessageGetmultiuserspointsresponse(_return);
	}
}