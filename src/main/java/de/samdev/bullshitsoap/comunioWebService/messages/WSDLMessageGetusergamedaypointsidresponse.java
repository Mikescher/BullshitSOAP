...
public class WSDLMessageGetusergamedaypointsidresponse extends WSDLMessage {

    public final WSDLObjectInt field_return;
	
	private WSDLMessageGetusergamedaypointsidresponse(WSDLObjectInt _return) {
	...
	public static WSDLMessageGetusergamedaypointsidresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getusergamedaypointsidResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetusergamedaypointsidresponse(WSDLObjectInt.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetusergamedaypointsidresponse create(WSDLObjectInt _return) {
		return new WSDLMessageGetusergamedaypointsidresponse(_return);
	}
}