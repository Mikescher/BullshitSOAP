...
public class WSDLMessageDeleteusertitleresponse extends WSDLMessage {

    public final WSDLObjectBoolean field_return;
	
	private WSDLMessageDeleteusertitleresponse(WSDLObjectBoolean _return) {
	...
	public static WSDLMessageDeleteusertitleresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "deleteusertitleResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageDeleteusertitleresponse(WSDLObjectBoolean.createFromXML(xml_return));
	}
	
	public static WSDLMessageDeleteusertitleresponse create(WSDLObjectBoolean _return) {
		return new WSDLMessageDeleteusertitleresponse(_return);
	}
}