...
public class WSDLMessageGetcommunitynameresponse extends WSDLMessage {

    public final WSDLObjectString field_return;
	
	private WSDLMessageGetcommunitynameresponse(WSDLObjectString _return) {
	...
	public static WSDLMessageGetcommunitynameresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getcommunitynameResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetcommunitynameresponse(WSDLObjectString.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetcommunitynameresponse create(WSDLObjectString _return) {
		return new WSDLMessageGetcommunitynameresponse(_return);
	}
}