...
public class WSDLMessageCheckmultipermissionsrequest extends WSDLMessage {

    public final WSDLObjectArrayofuserid field_arr_userid;
	
	private WSDLMessageCheckmultipermissionsrequest(WSDLObjectArrayofuserid _arr_userid) {
	...
	public static WSDLMessageCheckmultipermissionsrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "checkmultiPermissionsRequest");
		
		Element xml_arr_userid = getFirstChildrenIgnoreNamespace(message, "arr_userid");
		
		return new WSDLMessageCheckmultipermissionsrequest(WSDLObjectArrayofuserid.createFromXML(xml_arr_userid));
	}
	
	public static WSDLMessageCheckmultipermissionsrequest create(WSDLObjectArrayofuserid _arr_userid) {
		return new WSDLMessageCheckmultipermissionsrequest(_arr_userid);
	}
}