...
public class WSDLMessageGetalluserscurrentlineuprequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	private WSDLMessageGetalluserscurrentlineuprequest(WSDLObjectInt _userid) {
	...
	public static WSDLMessageGetalluserscurrentlineuprequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getalluserscurrentlineupRequest");
		
		Element xml_userid = getFirstChildrenIgnoreNamespace(message, "userid");
		
		return new WSDLMessageGetalluserscurrentlineuprequest(WSDLObjectInt.createFromXML(xml_userid));
	}
	
	public static WSDLMessageGetalluserscurrentlineuprequest create(WSDLObjectInt _userid) {
		return new WSDLMessageGetalluserscurrentlineuprequest(_userid);
	}
}