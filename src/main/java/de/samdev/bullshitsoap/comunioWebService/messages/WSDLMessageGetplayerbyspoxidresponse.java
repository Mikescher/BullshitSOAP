...
public class WSDLMessageGetplayerbyspoxidresponse extends WSDLMessage {

    public final WSDLObjectInt field_return;
	
	private WSDLMessageGetplayerbyspoxidresponse(WSDLObjectInt _return) {
	...
	public static WSDLMessageGetplayerbyspoxidresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayerbyspoxidResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetplayerbyspoxidresponse(WSDLObjectInt.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetplayerbyspoxidresponse create(WSDLObjectInt _return) {
		return new WSDLMessageGetplayerbyspoxidresponse(_return);
	}
}