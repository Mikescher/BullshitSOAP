...
public class WSDLMessagePlayer_deleteusertitlerequest extends WSDLMessage {
	...
	public static WSDLMessagePlayer_deleteusertitlerequest createFromXML(Document d) throws IOException {
		...
		Element xml_titleid = message.getFirstChildElement("titleid");
