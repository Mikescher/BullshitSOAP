...
public class WSDLMessagePlayer_deleteusertitlerequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	public final WSDLObjectInt field_titleid;
	
	private WSDLMessagePlayer_deleteusertitlerequest(WSDLObjectInt _userid, WSDLObjectInt _titleid) {
		super(WSDLNamespaceCollection.NAMESPACE_PATH_SERVICE_BASE);
		
		field_userid = _userid;
		field_titleid = _titleid;
	}
	...
	public Document serialize(String opname) {
		...
		message.appendChild(field_titleid.serialize("titleid"));
	...
	public static WSDLMessagePlayer_deleteusertitlerequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "player_deleteusertitleRequest");
		
		Element xml_userid = getFirstChildrenIgnoreNamespace(message, "userid");
		Element xml_titleid = getFirstChildrenIgnoreNamespace(message, "titleid");
		
		return new WSDLMessagePlayer_deleteusertitlerequest(WSDLObjectInt.createFromXML(xml_userid), WSDLObjectInt.createFromXML(xml_titleid));
	}
	
	public static WSDLMessagePlayer_deleteusertitlerequest create(WSDLObjectInt _userid, WSDLObjectInt _titleid) {
		return new WSDLMessagePlayer_deleteusertitlerequest(_userid, _titleid);
	}
}