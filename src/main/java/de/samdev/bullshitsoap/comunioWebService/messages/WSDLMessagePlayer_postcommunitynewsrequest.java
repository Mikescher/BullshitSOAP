...
public class WSDLMessagePlayer_postcommunitynewsrequest extends WSDLMessage {

    public final WSDLObjectString field_headline;
	
	public final WSDLObjectString field_content;
	
	private WSDLMessagePlayer_postcommunitynewsrequest(WSDLObjectString _headline, WSDLObjectString _content) {
	...
	public static WSDLMessagePlayer_postcommunitynewsrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "player_postcommunitynewsRequest");
		...
		return new WSDLMessagePlayer_postcommunitynewsrequest(WSDLObjectString.createFromXML(xml_headline), WSDLObjectString.createFromXML(xml_content));
	}
	
	public static WSDLMessagePlayer_postcommunitynewsrequest create(WSDLObjectString _headline, WSDLObjectString _content) {
		return new WSDLMessagePlayer_postcommunitynewsrequest(_headline, _content);
	}
}