...
public class WSDLMessageGetplayersbyclubidresponse extends WSDLMessage {

    public final WSDLObjectArrayofplayer field_return;
	
	private WSDLMessageGetplayersbyclubidresponse(WSDLObjectArrayofplayer _return) {
	...
	public static WSDLMessageGetplayersbyclubidresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayersbyclubidResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetplayersbyclubidresponse(WSDLObjectArrayofplayer.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetplayersbyclubidresponse create(WSDLObjectArrayofplayer _return) {
		return new WSDLMessageGetplayersbyclubidresponse(_return);
	}
}