...
public class WSDLMessageGetplayersinfobyuseridrequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	private WSDLMessageGetplayersinfobyuseridrequest(WSDLObjectInt _userid) {
	...
	public static WSDLMessageGetplayersinfobyuseridrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayersinfobyuseridRequest");
		
		Element xml_userid = getFirstChildrenIgnoreNamespace(message, "userid");
		
		return new WSDLMessageGetplayersinfobyuseridrequest(WSDLObjectInt.createFromXML(xml_userid));
	}
	
	public static WSDLMessageGetplayersinfobyuseridrequest create(WSDLObjectInt _userid) {
		return new WSDLMessageGetplayersinfobyuseridrequest(_userid);
	}
}