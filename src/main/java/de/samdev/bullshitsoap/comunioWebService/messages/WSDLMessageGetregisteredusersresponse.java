...
public class WSDLMessageGetregisteredusersresponse extends WSDLMessage {

    public final WSDLObjectArrayofuserid field_return;
	
	private WSDLMessageGetregisteredusersresponse(WSDLObjectArrayofuserid _return) {
	...
	public static WSDLMessageGetregisteredusersresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getregisteredusersResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetregisteredusersresponse(WSDLObjectArrayofuserid.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetregisteredusersresponse create(WSDLObjectArrayofuserid _return) {
		return new WSDLMessageGetregisteredusersresponse(_return);
	}
}