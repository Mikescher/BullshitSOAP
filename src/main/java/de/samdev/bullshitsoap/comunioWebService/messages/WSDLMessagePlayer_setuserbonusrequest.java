...
public class WSDLMessagePlayer_setuserbonusrequest extends WSDLMessage {
	...
	public static WSDLMessagePlayer_setuserbonusrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "player_setuserbonusRequest");
