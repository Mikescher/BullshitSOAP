...
public class WSDLMessagePlayer_setuserbonusrequest extends WSDLMessage {
	...
	private WSDLMessagePlayer_setuserbonusrequest(WSDLObjectInt _userid, WSDLObjectInt _amount, WSDLObjectString _reason) {
	...
	public static WSDLMessagePlayer_setuserbonusrequest createFromXML(Document d) throws IOException {
		...
		Element xml_amount = message.getFirstChildElement("amount");
		Element xml_reason = message.getFirstChildElement("reason");
		
		return new WSDLMessagePlayer_setuserbonusrequest(WSDLObjectInt.createFromXML(xml_userid), WSDLObjectInt.createFromXML(xml_amount), WSDLObjectString.createFromXML(xml_reason));
	}
	
	public static WSDLMessagePlayer_setuserbonusrequest create(WSDLObjectInt _userid, WSDLObjectInt _amount, WSDLObjectString _reason) {
		return new WSDLMessagePlayer_setuserbonusrequest(_userid, _amount, _reason);
	}
}