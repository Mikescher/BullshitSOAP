...
public class WSDLMessageGetplayerbyspoxidrequest extends WSDLMessage {

    public final WSDLObjectInt field_spoxid;
	
	private WSDLMessageGetplayerbyspoxidrequest(WSDLObjectInt _spoxid) {
		super(WSDLNamespaceCollection.NAMESPACE_PATH_SERVICE_BASE);
		
		field_spoxid = _spoxid;
	}
	...
	public Document serialize(String opname) {
		...
		message.appendChild(field_spoxid.serialize("spoxid"));
	...
	public static WSDLMessageGetplayerbyspoxidrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayerbyspoxidRequest");
		
		Element xml_spoxid = getFirstChildrenIgnoreNamespace(message, "spoxid");
		
		return new WSDLMessageGetplayerbyspoxidrequest(WSDLObjectInt.createFromXML(xml_spoxid));
	}
	
	public static WSDLMessageGetplayerbyspoxidrequest create(WSDLObjectInt _spoxid) {
		return new WSDLMessageGetplayerbyspoxidrequest(_spoxid);
	}
}