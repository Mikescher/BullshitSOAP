...
public class WSDLMessageGetserviceexpirationdaterequest extends WSDLMessage {
	...
	public static WSDLMessageGetserviceexpirationdaterequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getserviceexpirationdateRequest");
