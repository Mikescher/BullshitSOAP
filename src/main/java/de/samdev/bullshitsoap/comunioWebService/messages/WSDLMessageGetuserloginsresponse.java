...
public class WSDLMessageGetuserloginsresponse extends WSDLMessage {

    public final WSDLObjectArrayoflogin field_return;
	
	private WSDLMessageGetuserloginsresponse(WSDLObjectArrayoflogin _return) {
	...
	public static WSDLMessageGetuserloginsresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getuserloginsResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetuserloginsresponse(WSDLObjectArrayoflogin.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetuserloginsresponse create(WSDLObjectArrayoflogin _return) {
		return new WSDLMessageGetuserloginsresponse(_return);
	}
}