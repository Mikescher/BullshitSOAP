...
public class WSDLMessageGetmultiusersgamdaybudgetstaterequest extends WSDLMessage {
	...
	public static WSDLMessageGetmultiusersgamdaybudgetstaterequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getmultiusersgamdaybudgetstateRequest");
