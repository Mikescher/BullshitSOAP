...
public class WSDLMessageGetusersfirstnamerequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	private WSDLMessageGetusersfirstnamerequest(WSDLObjectInt _userid) {
	...
	public static WSDLMessageGetusersfirstnamerequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getusersfirstnameRequest");
		
		Element xml_userid = getFirstChildrenIgnoreNamespace(message, "userid");
		
		return new WSDLMessageGetusersfirstnamerequest(WSDLObjectInt.createFromXML(xml_userid));
	}
	
	public static WSDLMessageGetusersfirstnamerequest create(WSDLObjectInt _userid) {
		return new WSDLMessageGetusersfirstnamerequest(_userid);
	}
}