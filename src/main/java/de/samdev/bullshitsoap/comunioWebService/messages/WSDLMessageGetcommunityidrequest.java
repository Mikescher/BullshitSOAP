...
public class WSDLMessageGetcommunityidrequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	private WSDLMessageGetcommunityidrequest(WSDLObjectInt _userid) {
	...
	public static WSDLMessageGetcommunityidrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getcommunityidRequest");
		
		Element xml_userid = getFirstChildrenIgnoreNamespace(message, "userid");
		
		return new WSDLMessageGetcommunityidrequest(WSDLObjectInt.createFromXML(xml_userid));
	}
	
	public static WSDLMessageGetcommunityidrequest create(WSDLObjectInt _userid) {
		return new WSDLMessageGetcommunityidrequest(_userid);
	}
}