...
public class WSDLMessageGetplayersboughtrequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	public final WSDLObjectInt field_gameday;
	
	private WSDLMessageGetplayersboughtrequest(WSDLObjectInt _userid, WSDLObjectInt _gameday) {
	...
	public static WSDLMessageGetplayersboughtrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayersboughtRequest");
		...
		return new WSDLMessageGetplayersboughtrequest(WSDLObjectInt.createFromXML(xml_userid), WSDLObjectInt.createFromXML(xml_gameday));
	}
	
	public static WSDLMessageGetplayersboughtrequest create(WSDLObjectInt _userid, WSDLObjectInt _gameday) {
		return new WSDLMessageGetplayersboughtrequest(_userid, _gameday);
	}
}