...
public class WSDLMessageGetcommunitybonusrequest extends WSDLMessage {

    public final WSDLObjectInt field_communityid;
	
	private WSDLMessageGetcommunitybonusrequest(WSDLObjectInt _communityid) {
	...
	public static WSDLMessageGetcommunitybonusrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getcommunitybonusRequest");
		
		Element xml_communityid = getFirstChildrenIgnoreNamespace(message, "communityid");
		
		return new WSDLMessageGetcommunitybonusrequest(WSDLObjectInt.createFromXML(xml_communityid));
	}
	
	public static WSDLMessageGetcommunitybonusrequest create(WSDLObjectInt _communityid) {
		return new WSDLMessageGetcommunitybonusrequest(_communityid);
	}
}