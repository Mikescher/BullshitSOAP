...
public class WSDLMessageCancelservicerequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	private WSDLMessageCancelservicerequest(WSDLObjectInt _userid) {
	...
	public static WSDLMessageCancelservicerequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "cancelserviceRequest");
		
		Element xml_userid = getFirstChildrenIgnoreNamespace(message, "userid");
		
		return new WSDLMessageCancelservicerequest(WSDLObjectInt.createFromXML(xml_userid));
	}
	
	public static WSDLMessageCancelservicerequest create(WSDLObjectInt _userid) {
		return new WSDLMessageCancelservicerequest(_userid);
	}
}