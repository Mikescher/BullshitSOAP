...
public class WSDLMessageGetplayergamedaypointsresponse extends WSDLMessage {

    public final WSDLObjectInt field_return;
	
	private WSDLMessageGetplayergamedaypointsresponse(WSDLObjectInt _return) {
	...
	public static WSDLMessageGetplayergamedaypointsresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayergamedaypointsResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetplayergamedaypointsresponse(WSDLObjectInt.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetplayergamedaypointsresponse create(WSDLObjectInt _return) {
		return new WSDLMessageGetplayergamedaypointsresponse(_return);
	}
}