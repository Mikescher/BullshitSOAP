...
public class WSDLMessageGetmultiuserspointsrequest extends WSDLMessage {

    public final WSDLObjectArrayofuserid field_arr_userid;
	
	private WSDLMessageGetmultiuserspointsrequest(WSDLObjectArrayofuserid _arr_userid) {
	...
	public static WSDLMessageGetmultiuserspointsrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getmultiuserspointsRequest");
		
		Element xml_arr_userid = getFirstChildrenIgnoreNamespace(message, "arr_userid");
		
		return new WSDLMessageGetmultiuserspointsrequest(WSDLObjectArrayofuserid.createFromXML(xml_arr_userid));
	}
	
	public static WSDLMessageGetmultiuserspointsrequest create(WSDLObjectArrayofuserid _arr_userid) {
		return new WSDLMessageGetmultiuserspointsrequest(_arr_userid);
	}
}