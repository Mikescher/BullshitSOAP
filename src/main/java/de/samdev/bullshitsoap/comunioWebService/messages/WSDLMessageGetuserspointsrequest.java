...
public class WSDLMessageGetuserspointsrequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	private WSDLMessageGetuserspointsrequest(WSDLObjectInt _userid) {
	...
	public static WSDLMessageGetuserspointsrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getuserspointsRequest");
		
		Element xml_userid = getFirstChildrenIgnoreNamespace(message, "userid");
		
		return new WSDLMessageGetuserspointsrequest(WSDLObjectInt.createFromXML(xml_userid));
	}
	
	public static WSDLMessageGetuserspointsrequest create(WSDLObjectInt _userid) {
		return new WSDLMessageGetuserspointsrequest(_userid);
	}
}