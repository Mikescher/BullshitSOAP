...
public class WSDLMessageGetcommunitybonusresponse extends WSDLMessage {

    public final WSDLObjectInt field_return;
	
	private WSDLMessageGetcommunitybonusresponse(WSDLObjectInt _return) {
	...
	public static WSDLMessageGetcommunitybonusresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getcommunitybonusResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetcommunitybonusresponse(WSDLObjectInt.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetcommunitybonusresponse create(WSDLObjectInt _return) {
		return new WSDLMessageGetcommunitybonusresponse(_return);
	}
}