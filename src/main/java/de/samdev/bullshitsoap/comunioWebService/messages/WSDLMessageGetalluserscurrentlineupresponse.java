...
public class WSDLMessageGetalluserscurrentlineupresponse extends WSDLMessage {

    public final WSDLObjectArrayofplayerlineup field_return;
	
	private WSDLMessageGetalluserscurrentlineupresponse(WSDLObjectArrayofplayerlineup _return) {
	...
	public static WSDLMessageGetalluserscurrentlineupresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getalluserscurrentlineupResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetalluserscurrentlineupresponse(WSDLObjectArrayofplayerlineup.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetalluserscurrentlineupresponse create(WSDLObjectArrayofplayerlineup _return) {
		return new WSDLMessageGetalluserscurrentlineupresponse(_return);
	}
}