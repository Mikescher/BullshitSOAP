...
public class WSDLMessageGetserviceexpirationdateresponse extends WSDLMessage {

    public final WSDLObjectString field_return;
	
	private WSDLMessageGetserviceexpirationdateresponse(WSDLObjectString _return) {
	...
	public static WSDLMessageGetserviceexpirationdateresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getserviceexpirationdateResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetserviceexpirationdateresponse(WSDLObjectString.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetserviceexpirationdateresponse create(WSDLObjectString _return) {
		return new WSDLMessageGetserviceexpirationdateresponse(_return);
	}
}