...
public class WSDLMessageGetuseridresponse extends WSDLMessage {

    public final WSDLObjectInt field_return;
	
	private WSDLMessageGetuseridresponse(WSDLObjectInt _return) {
	...
	public static WSDLMessageGetuseridresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getuseridResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetuseridresponse(WSDLObjectInt.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetuseridresponse create(WSDLObjectInt _return) {
		return new WSDLMessageGetuseridresponse(_return);
	}
}