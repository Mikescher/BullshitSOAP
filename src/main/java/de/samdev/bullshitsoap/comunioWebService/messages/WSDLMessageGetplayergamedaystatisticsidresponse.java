...
public class WSDLMessageGetplayergamedaystatisticsidresponse extends WSDLMessage {

    public final WSDLObjectTradablematchstats field_return;
	
	private WSDLMessageGetplayergamedaystatisticsidresponse(WSDLObjectTradablematchstats _return) {
	...
	public static WSDLMessageGetplayergamedaystatisticsidresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayergamedaystatisticsidResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetplayergamedaystatisticsidresponse(WSDLObjectTradablematchstats.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetplayergamedaystatisticsidresponse create(WSDLObjectTradablematchstats _return) {
		return new WSDLMessageGetplayergamedaystatisticsidresponse(_return);
	}
}