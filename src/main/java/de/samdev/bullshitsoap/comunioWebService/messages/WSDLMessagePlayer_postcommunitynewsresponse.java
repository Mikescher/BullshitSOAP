...
public class WSDLMessagePlayer_postcommunitynewsresponse extends WSDLMessage {

    public final WSDLObjectBoolean field_return;
	
	private WSDLMessagePlayer_postcommunitynewsresponse(WSDLObjectBoolean _return) {
	...
	public static WSDLMessagePlayer_postcommunitynewsresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "player_postcommunitynewsResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessagePlayer_postcommunitynewsresponse(WSDLObjectBoolean.createFromXML(xml_return));
	}
	
	public static WSDLMessagePlayer_postcommunitynewsresponse create(WSDLObjectBoolean _return) {
		return new WSDLMessagePlayer_postcommunitynewsresponse(_return);
	}
}