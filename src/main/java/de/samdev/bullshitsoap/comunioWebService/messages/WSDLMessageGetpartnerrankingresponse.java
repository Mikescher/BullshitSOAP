...
public class WSDLMessageGetpartnerrankingresponse extends WSDLMessage {

    public final WSDLObjectArrayofuser field_return;
	
	private WSDLMessageGetpartnerrankingresponse(WSDLObjectArrayofuser _return) {
	...
	public static WSDLMessageGetpartnerrankingresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getpartnerrankingResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetpartnerrankingresponse(WSDLObjectArrayofuser.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetpartnerrankingresponse create(WSDLObjectArrayofuser _return) {
		return new WSDLMessageGetpartnerrankingresponse(_return);
	}
}