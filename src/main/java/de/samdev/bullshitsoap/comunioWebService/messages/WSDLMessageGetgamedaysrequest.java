...
public class WSDLMessageGetgamedaysrequest extends WSDLMessage {
	
	private WSDLMessageGetgamedaysrequest() {
	...
	public static WSDLMessageGetgamedaysrequest createFromXML(Document d) throws IOException {
		return new WSDLMessageGetgamedaysrequest();
	}
	
	public static WSDLMessageGetgamedaysrequest create() {
		return new WSDLMessageGetgamedaysrequest();
	}
}