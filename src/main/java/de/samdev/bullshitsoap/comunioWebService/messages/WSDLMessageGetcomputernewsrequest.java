...
public class WSDLMessageGetcomputernewsrequest extends WSDLMessage {
	...
	public static WSDLMessageGetcomputernewsrequest createFromXML(Document d) throws IOException {
		...
		Element xml_days = message.getFirstChildElement("days");
		Element xml_items = message.getFirstChildElement("items");
