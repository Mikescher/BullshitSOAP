...
public class WSDLMessagePlayer_deleteteamtitlerequest extends WSDLMessage {

    public final WSDLObjectInt field_titleid;
	
	private WSDLMessagePlayer_deleteteamtitlerequest(WSDLObjectInt _titleid) {
	...
	public static WSDLMessagePlayer_deleteteamtitlerequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "player_deleteteamtitleRequest");
		
		Element xml_titleid = getFirstChildrenIgnoreNamespace(message, "titleid");
		
		return new WSDLMessagePlayer_deleteteamtitlerequest(WSDLObjectInt.createFromXML(xml_titleid));
	}
	
	public static WSDLMessagePlayer_deleteteamtitlerequest create(WSDLObjectInt _titleid) {
		return new WSDLMessagePlayer_deleteteamtitlerequest(_titleid);
	}
}