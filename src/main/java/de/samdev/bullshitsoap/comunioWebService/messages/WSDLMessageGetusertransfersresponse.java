...
public class WSDLMessageGetusertransfersresponse extends WSDLMessage {

    public final WSDLObjectArrayoftransferitem field_return;
	
	private WSDLMessageGetusertransfersresponse(WSDLObjectArrayoftransferitem _return) {
	...
	public static WSDLMessageGetusertransfersresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getusertransfersResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetusertransfersresponse(WSDLObjectArrayoftransferitem.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetusertransfersresponse create(WSDLObjectArrayoftransferitem _return) {
		return new WSDLMessageGetusertransfersresponse(_return);
	}
}