...
public class WSDLMessagePlayer_deleteusertitleresponse extends WSDLMessage {

    public final WSDLObjectBoolean field_return;
	
	private WSDLMessagePlayer_deleteusertitleresponse(WSDLObjectBoolean _return) {
	...
	public static WSDLMessagePlayer_deleteusertitleresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "player_deleteusertitleResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessagePlayer_deleteusertitleresponse(WSDLObjectBoolean.createFromXML(xml_return));
	}
	
	public static WSDLMessagePlayer_deleteusertitleresponse create(WSDLObjectBoolean _return) {
		return new WSDLMessagePlayer_deleteusertitleresponse(_return);
	}
}