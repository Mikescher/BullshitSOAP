...
public class WSDLMessagePlayer_getusertitleresponse extends WSDLMessage {

    public final WSDLObjectArrayoftitleid field_return;
	
	private WSDLMessagePlayer_getusertitleresponse(WSDLObjectArrayoftitleid _return) {
	...
	public static WSDLMessagePlayer_getusertitleresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "player_getusertitleResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessagePlayer_getusertitleresponse(WSDLObjectArrayoftitleid.createFromXML(xml_return));
	}
	
	public static WSDLMessagePlayer_getusertitleresponse create(WSDLObjectArrayoftitleid _return) {
		return new WSDLMessagePlayer_getusertitleresponse(_return);
	}
}