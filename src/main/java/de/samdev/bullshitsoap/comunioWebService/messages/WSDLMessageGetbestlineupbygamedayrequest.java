...
public class WSDLMessageGetbestlineupbygamedayrequest extends WSDLMessage {

    public final WSDLObjectInt field_gameday;
	
	private WSDLMessageGetbestlineupbygamedayrequest(WSDLObjectInt _gameday) {
	...
	public static WSDLMessageGetbestlineupbygamedayrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getbestlineupbygamedayRequest");
		
		Element xml_gameday = getFirstChildrenIgnoreNamespace(message, "gameday");
		
		return new WSDLMessageGetbestlineupbygamedayrequest(WSDLObjectInt.createFromXML(xml_gameday));
	}
	
	public static WSDLMessageGetbestlineupbygamedayrequest create(WSDLObjectInt _gameday) {
		return new WSDLMessageGetbestlineupbygamedayrequest(_gameday);
	}
}