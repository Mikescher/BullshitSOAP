...
public class WSDLMessageCheckcommunitypermissionsrequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	private WSDLMessageCheckcommunitypermissionsrequest(WSDLObjectInt _userid) {
	...
	public static WSDLMessageCheckcommunitypermissionsrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "checkcommunitypermissionsRequest");
		
		Element xml_userid = getFirstChildrenIgnoreNamespace(message, "userid");
		
		return new WSDLMessageCheckcommunitypermissionsrequest(WSDLObjectInt.createFromXML(xml_userid));
	}
	
	public static WSDLMessageCheckcommunitypermissionsrequest create(WSDLObjectInt _userid) {
		return new WSDLMessageCheckcommunitypermissionsrequest(_userid);
	}
}