...
public class WSDLMessageCheckpermissionsrequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	private WSDLMessageCheckpermissionsrequest(WSDLObjectInt _userid) {
	...
	public static WSDLMessageCheckpermissionsrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "checkPermissionsRequest");
		
		Element xml_userid = getFirstChildrenIgnoreNamespace(message, "userid");
		
		return new WSDLMessageCheckpermissionsrequest(WSDLObjectInt.createFromXML(xml_userid));
	}
	
	public static WSDLMessageCheckpermissionsrequest create(WSDLObjectInt _userid) {
		return new WSDLMessageCheckpermissionsrequest(_userid);
	}
}