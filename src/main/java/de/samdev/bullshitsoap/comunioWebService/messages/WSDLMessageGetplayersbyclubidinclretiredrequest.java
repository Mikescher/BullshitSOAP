...
public class WSDLMessageGetplayersbyclubidinclretiredrequest extends WSDLMessage {

    public final WSDLObjectInt field_clubid;
	
	private WSDLMessageGetplayersbyclubidinclretiredrequest(WSDLObjectInt _clubid) {
	...
	public static WSDLMessageGetplayersbyclubidinclretiredrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayersbyclubidinclretiredRequest");
		
		Element xml_clubid = getFirstChildrenIgnoreNamespace(message, "clubid");
		
		return new WSDLMessageGetplayersbyclubidinclretiredrequest(WSDLObjectInt.createFromXML(xml_clubid));
	}
	
	public static WSDLMessageGetplayersbyclubidinclretiredrequest create(WSDLObjectInt _clubid) {
		return new WSDLMessageGetplayersbyclubidinclretiredrequest(_clubid);
	}
}