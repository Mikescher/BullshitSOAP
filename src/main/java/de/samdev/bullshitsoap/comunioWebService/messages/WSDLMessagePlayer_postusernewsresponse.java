...
public class WSDLMessagePlayer_postusernewsresponse extends WSDLMessage {

    public final WSDLObjectBoolean field_return;
	
	private WSDLMessagePlayer_postusernewsresponse(WSDLObjectBoolean _return) {
	...
	public static WSDLMessagePlayer_postusernewsresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "player_postusernewsResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessagePlayer_postusernewsresponse(WSDLObjectBoolean.createFromXML(xml_return));
	}
	
	public static WSDLMessagePlayer_postusernewsresponse create(WSDLObjectBoolean _return) {
		return new WSDLMessagePlayer_postusernewsresponse(_return);
	}
}