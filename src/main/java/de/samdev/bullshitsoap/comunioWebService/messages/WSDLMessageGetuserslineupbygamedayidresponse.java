...
public class WSDLMessageGetuserslineupbygamedayidresponse extends WSDLMessage {

    public final WSDLObjectArrayofplayerlineup field_return;
	
	private WSDLMessageGetuserslineupbygamedayidresponse(WSDLObjectArrayofplayerlineup _return) {
	...
	public static WSDLMessageGetuserslineupbygamedayidresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getuserslineupbygamedayidResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetuserslineupbygamedayidresponse(WSDLObjectArrayofplayerlineup.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetuserslineupbygamedayidresponse create(WSDLObjectArrayofplayerlineup _return) {
		return new WSDLMessageGetuserslineupbygamedayidresponse(_return);
	}
}