...
public class WSDLMessageGetplayergamedaystatisticsidrequest extends WSDLMessage {
	...
	public static WSDLMessageGetplayergamedaystatisticsidrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayergamedaystatisticsidRequest");
