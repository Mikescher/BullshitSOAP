...
public class WSDLMessageGetusersgamdaybudgetstateresponse extends WSDLMessage {

    public final WSDLObjectBoolean field_return;
	
	private WSDLMessageGetusersgamdaybudgetstateresponse(WSDLObjectBoolean _return) {
	...
	public static WSDLMessageGetusersgamdaybudgetstateresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getusersgamdaybudgetstateResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetusersgamdaybudgetstateresponse(WSDLObjectBoolean.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetusersgamdaybudgetstateresponse create(WSDLObjectBoolean _return) {
		return new WSDLMessageGetusersgamdaybudgetstateresponse(_return);
	}
}