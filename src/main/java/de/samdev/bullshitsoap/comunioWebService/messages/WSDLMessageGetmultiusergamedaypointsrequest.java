...
public class WSDLMessageGetmultiusergamedaypointsrequest extends WSDLMessage {

    public final WSDLObjectArrayofuserid field_arr_userid;
	
	public final WSDLObjectInt field_gameday;
	
	private WSDLMessageGetmultiusergamedaypointsrequest(WSDLObjectArrayofuserid _arr_userid, WSDLObjectInt _gameday) {
	...
	public static WSDLMessageGetmultiusergamedaypointsrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getmultiusergamedaypointsRequest");
		...
		return new WSDLMessageGetmultiusergamedaypointsrequest(WSDLObjectArrayofuserid.createFromXML(xml_arr_userid), WSDLObjectInt.createFromXML(xml_gameday));
	}
	
	public static WSDLMessageGetmultiusergamedaypointsrequest create(WSDLObjectArrayofuserid _arr_userid, WSDLObjectInt _gameday) {
		return new WSDLMessageGetmultiusergamedaypointsrequest(_arr_userid, _gameday);
	}
}