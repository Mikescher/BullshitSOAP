...
public class WSDLMessageGetuserspointsresponse extends WSDLMessage {

    public final WSDLObjectInt field_return;
	
	private WSDLMessageGetuserspointsresponse(WSDLObjectInt _return) {
	...
	public static WSDLMessageGetuserspointsresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getuserspointsResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetuserspointsresponse(WSDLObjectInt.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetuserspointsresponse create(WSDLObjectInt _return) {
		return new WSDLMessageGetuserspointsresponse(_return);
	}
}