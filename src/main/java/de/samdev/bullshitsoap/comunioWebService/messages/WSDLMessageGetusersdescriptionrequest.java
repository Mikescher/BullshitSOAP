...
public class WSDLMessageGetusersdescriptionrequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	private WSDLMessageGetusersdescriptionrequest(WSDLObjectInt _userid) {
	...
	public static WSDLMessageGetusersdescriptionrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getusersdescriptionRequest");
		
		Element xml_userid = getFirstChildrenIgnoreNamespace(message, "userid");
		
		return new WSDLMessageGetusersdescriptionrequest(WSDLObjectInt.createFromXML(xml_userid));
	}
	
	public static WSDLMessageGetusersdescriptionrequest create(WSDLObjectInt _userid) {
		return new WSDLMessageGetusersdescriptionrequest(_userid);
	}
}