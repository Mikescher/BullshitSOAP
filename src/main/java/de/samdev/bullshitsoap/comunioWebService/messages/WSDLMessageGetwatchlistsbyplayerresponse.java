...
public class WSDLMessageGetwatchlistsbyplayerresponse extends WSDLMessage {

    public final WSDLObjectArrayofplayerid field_return;
	
	private WSDLMessageGetwatchlistsbyplayerresponse(WSDLObjectArrayofplayerid _return) {
	...
	public static WSDLMessageGetwatchlistsbyplayerresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getwatchlistsbyplayerResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetwatchlistsbyplayerresponse(WSDLObjectArrayofplayerid.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetwatchlistsbyplayerresponse create(WSDLObjectArrayofplayerid _return) {
		return new WSDLMessageGetwatchlistsbyplayerresponse(_return);
	}
}