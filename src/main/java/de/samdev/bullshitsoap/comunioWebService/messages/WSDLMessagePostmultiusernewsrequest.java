...
public class WSDLMessagePostmultiusernewsrequest extends WSDLMessage {
	...
	public static WSDLMessagePostmultiusernewsrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "postmultiusernewsRequest");
