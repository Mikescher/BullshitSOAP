...
public class WSDLMessageGetloginrequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	private WSDLMessageGetloginrequest(WSDLObjectInt _userid) {
	...
	public static WSDLMessageGetloginrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getloginRequest");
		
		Element xml_userid = getFirstChildrenIgnoreNamespace(message, "userid");
		
		return new WSDLMessageGetloginrequest(WSDLObjectInt.createFromXML(xml_userid));
	}
	
	public static WSDLMessageGetloginrequest create(WSDLObjectInt _userid) {
		return new WSDLMessageGetloginrequest(_userid);
	}
}