...
public class WSDLMessagePlayer_getusertitlerequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	private WSDLMessagePlayer_getusertitlerequest(WSDLObjectInt _userid) {
	...
	public static WSDLMessagePlayer_getusertitlerequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "player_getusertitleRequest");
		
		Element xml_userid = getFirstChildrenIgnoreNamespace(message, "userid");
		
		return new WSDLMessagePlayer_getusertitlerequest(WSDLObjectInt.createFromXML(xml_userid));
	}
	
	public static WSDLMessagePlayer_getusertitlerequest create(WSDLObjectInt _userid) {
		return new WSDLMessagePlayer_getusertitlerequest(_userid);
	}
}