...
public class WSDLMessageGetusersplayerbygamedayresponse extends WSDLMessage {

    public final WSDLObjectArrayofplayerlineup field_return;
	
	private WSDLMessageGetusersplayerbygamedayresponse(WSDLObjectArrayofplayerlineup _return) {
	...
	public static WSDLMessageGetusersplayerbygamedayresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getusersplayerbygamedayResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetusersplayerbygamedayresponse(WSDLObjectArrayofplayerlineup.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetusersplayerbygamedayresponse create(WSDLObjectArrayofplayerlineup _return) {
		return new WSDLMessageGetusersplayerbygamedayresponse(_return);
	}
}