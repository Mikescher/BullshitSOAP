...
public class WSDLMessageGetteamsizeresponse extends WSDLMessage {

    public final WSDLObjectInt field_return;
	
	private WSDLMessageGetteamsizeresponse(WSDLObjectInt _return) {
	...
	public static WSDLMessageGetteamsizeresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getteamsizeResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetteamsizeresponse(WSDLObjectInt.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetteamsizeresponse create(WSDLObjectInt _return) {
		return new WSDLMessageGetteamsizeresponse(_return);
	}
}