...
public class WSDLMessageGetusersnameresponse extends WSDLMessage {

    public final WSDLObjectString field_return;
	
	private WSDLMessageGetusersnameresponse(WSDLObjectString _return) {
	...
	public static WSDLMessageGetusersnameresponse createFromXML(Document d) throws IOException {
		...
		return new WSDLMessageGetusersnameresponse(WSDLObjectString.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetusersnameresponse create(WSDLObjectString _return) {
		return new WSDLMessageGetusersnameresponse(_return);
	}
}