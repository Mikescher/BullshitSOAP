...
public class WSDLMessageGetusersnameresponse extends WSDLMessage {
	...
	public static WSDLMessageGetusersnameresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getusersnameResponse");
