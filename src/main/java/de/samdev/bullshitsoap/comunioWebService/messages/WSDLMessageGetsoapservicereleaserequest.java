...
public class WSDLMessageGetsoapservicereleaserequest extends WSDLMessage {
	
	private WSDLMessageGetsoapservicereleaserequest() {
	...
	public static WSDLMessageGetsoapservicereleaserequest createFromXML(Document d) throws IOException {
		return new WSDLMessageGetsoapservicereleaserequest();
	}
	
	public static WSDLMessageGetsoapservicereleaserequest create() {
		return new WSDLMessageGetsoapservicereleaserequest();
	}
}