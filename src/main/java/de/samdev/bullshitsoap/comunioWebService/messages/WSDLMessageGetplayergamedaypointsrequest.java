...
public class WSDLMessageGetplayergamedaypointsrequest extends WSDLMessage {

    public final WSDLObjectInt field_playerid;
	
	public final WSDLObjectInt field_gameday;
	
	private WSDLMessageGetplayergamedaypointsrequest(WSDLObjectInt _playerid, WSDLObjectInt _gameday) {
	...
	public static WSDLMessageGetplayergamedaypointsrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayergamedaypointsRequest");
		...
		return new WSDLMessageGetplayergamedaypointsrequest(WSDLObjectInt.createFromXML(xml_playerid), WSDLObjectInt.createFromXML(xml_gameday));
	}
	
	public static WSDLMessageGetplayergamedaypointsrequest create(WSDLObjectInt _playerid, WSDLObjectInt _gameday) {
		return new WSDLMessageGetplayergamedaypointsrequest(_playerid, _gameday);
	}
}