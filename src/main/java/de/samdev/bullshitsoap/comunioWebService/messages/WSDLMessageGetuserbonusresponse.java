...
public class WSDLMessageGetuserbonusresponse extends WSDLMessage {

    public final WSDLObjectInt field_return;
	
	private WSDLMessageGetuserbonusresponse(WSDLObjectInt _return) {
	...
	public static WSDLMessageGetuserbonusresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getuserbonusResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetuserbonusresponse(WSDLObjectInt.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetuserbonusresponse create(WSDLObjectInt _return) {
		return new WSDLMessageGetuserbonusresponse(_return);
	}
}