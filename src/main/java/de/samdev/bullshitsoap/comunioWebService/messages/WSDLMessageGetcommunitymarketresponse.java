...
public class WSDLMessageGetcommunitymarketresponse extends WSDLMessage {

    public final WSDLObjectArrayofplayerexchangemarket field_return;
	
	private WSDLMessageGetcommunitymarketresponse(WSDLObjectArrayofplayerexchangemarket _return) {
	...
	public static WSDLMessageGetcommunitymarketresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getcommunitymarketResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetcommunitymarketresponse(WSDLObjectArrayofplayerexchangemarket.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetcommunitymarketresponse create(WSDLObjectArrayofplayerexchangemarket _return) {
		return new WSDLMessageGetcommunitymarketresponse(_return);
	}
}