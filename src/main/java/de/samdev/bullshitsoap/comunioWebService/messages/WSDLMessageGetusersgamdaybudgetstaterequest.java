...
public class WSDLMessageGetusersgamdaybudgetstaterequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	private WSDLMessageGetusersgamdaybudgetstaterequest(WSDLObjectInt _userid) {
	...
	public static WSDLMessageGetusersgamdaybudgetstaterequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getusersgamdaybudgetstateRequest");
		
		Element xml_userid = getFirstChildrenIgnoreNamespace(message, "userid");
		
		return new WSDLMessageGetusersgamdaybudgetstaterequest(WSDLObjectInt.createFromXML(xml_userid));
	}
	
	public static WSDLMessageGetusersgamdaybudgetstaterequest create(WSDLObjectInt _userid) {
		return new WSDLMessageGetusersgamdaybudgetstaterequest(_userid);
	}
}