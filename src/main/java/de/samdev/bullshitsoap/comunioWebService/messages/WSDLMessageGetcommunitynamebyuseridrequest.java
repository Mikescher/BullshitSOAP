...
public class WSDLMessageGetcommunitynamebyuseridrequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	private WSDLMessageGetcommunitynamebyuseridrequest(WSDLObjectInt _userid) {
	...
	public static WSDLMessageGetcommunitynamebyuseridrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getcommunitynamebyuseridRequest");
		
		Element xml_userid = getFirstChildrenIgnoreNamespace(message, "userid");
		
		return new WSDLMessageGetcommunitynamebyuseridrequest(WSDLObjectInt.createFromXML(xml_userid));
	}
	
	public static WSDLMessageGetcommunitynamebyuseridrequest create(WSDLObjectInt _userid) {
		return new WSDLMessageGetcommunitynamebyuseridrequest(_userid);
	}
}