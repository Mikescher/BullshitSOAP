...
public class WSDLMessageGetcommunityadminsresponse extends WSDLMessage {

    public final WSDLObjectArrayofuserid field_return;
	
	private WSDLMessageGetcommunityadminsresponse(WSDLObjectArrayofuserid _return) {
	...
	public static WSDLMessageGetcommunityadminsresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getcommunityadminsResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetcommunityadminsresponse(WSDLObjectArrayofuserid.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetcommunityadminsresponse create(WSDLObjectArrayofuserid _return) {
		return new WSDLMessageGetcommunityadminsresponse(_return);
	}
}