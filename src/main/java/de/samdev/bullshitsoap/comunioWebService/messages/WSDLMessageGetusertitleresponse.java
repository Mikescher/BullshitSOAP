...
public class WSDLMessageGetusertitleresponse extends WSDLMessage {

    public final WSDLObjectArrayoftitleid field_return;
	
	private WSDLMessageGetusertitleresponse(WSDLObjectArrayoftitleid _return) {
	...
	public static WSDLMessageGetusertitleresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getusertitleResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessageGetusertitleresponse(WSDLObjectArrayoftitleid.createFromXML(xml_return));
	}
	
	public static WSDLMessageGetusertitleresponse create(WSDLObjectArrayoftitleid _return) {
		return new WSDLMessageGetusertitleresponse(_return);
	}
}