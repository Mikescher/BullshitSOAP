...
public class WSDLMessageGetplayergamedaystatisticsrequest extends WSDLMessage {

    public final WSDLObjectInt field_playerid;
	
	public final WSDLObjectInt field_gameday;
	
	private WSDLMessageGetplayergamedaystatisticsrequest(WSDLObjectInt _playerid, WSDLObjectInt _gameday) {
	...
	public static WSDLMessageGetplayergamedaystatisticsrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getplayergamedaystatisticsRequest");
		...
		return new WSDLMessageGetplayergamedaystatisticsrequest(WSDLObjectInt.createFromXML(xml_playerid), WSDLObjectInt.createFromXML(xml_gameday));
	}
	
	public static WSDLMessageGetplayergamedaystatisticsrequest create(WSDLObjectInt _playerid, WSDLObjectInt _gameday) {
		return new WSDLMessageGetplayergamedaystatisticsrequest(_playerid, _gameday);
	}
}