...
public class WSDLMessagePostcommunitynewsresponse extends WSDLMessage {

    public final WSDLObjectBoolean field_return;
	
	private WSDLMessagePostcommunitynewsresponse(WSDLObjectBoolean _return) {
	...
	public static WSDLMessagePostcommunitynewsresponse createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "postcommunitynewsResponse");
		
		Element xml_return = getFirstChildrenIgnoreNamespace(message, "return");
		
		return new WSDLMessagePostcommunitynewsresponse(WSDLObjectBoolean.createFromXML(xml_return));
	}
	
	public static WSDLMessagePostcommunitynewsresponse create(WSDLObjectBoolean _return) {
		return new WSDLMessagePostcommunitynewsresponse(_return);
	}
}