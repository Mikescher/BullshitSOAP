...
public class WSDLMessageGetalluserslineupbygamedayrequest extends WSDLMessage {

    public final WSDLObjectInt field_userid;
	
	public final WSDLObjectInt field_gameday;
	
	private WSDLMessageGetalluserslineupbygamedayrequest(WSDLObjectInt _userid, WSDLObjectInt _gameday) {
	...
	public static WSDLMessageGetalluserslineupbygamedayrequest createFromXML(Document d, String opname) throws IOException {
		...
		Element message = getFirstChildrenIgnoreNamespace(body, "getalluserslineupbygamedayRequest");
		...
		return new WSDLMessageGetalluserslineupbygamedayrequest(WSDLObjectInt.createFromXML(xml_userid), WSDLObjectInt.createFromXML(xml_gameday));
	}
	
	public static WSDLMessageGetalluserslineupbygamedayrequest create(WSDLObjectInt _userid, WSDLObjectInt _gameday) {
		return new WSDLMessageGetalluserslineupbygamedayrequest(_userid, _gameday);
	}
}